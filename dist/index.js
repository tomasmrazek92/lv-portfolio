...
#define LOW_PRECISION`),t}function Yf(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Ea?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===Bo?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===Qe&&(t="SHADOWMAP_TYPE_VSM"),t}function Zf(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case qn:case $n:t="ENVMAP_TYPE_CUBE";break;case Ki:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Jf(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case $n:t="ENVMAP_MODE_REFRACTION";break}return t}function Kf(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Ia:t="ENVMAP_BLENDING_MULTIPLY";break;case il:t="ENVMAP_BLENDING_MIX";break;case sl:t="ENVMAP_BLENDING_ADD";break}return t}function Qf(i){let t=i.envMapCubeUVHeight;if(t===null)return null;let e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function jf(i,t,e,n){let s=i.getContext(),r=e.defines,a=e.vertexShader,o=e.fragmentShader,l=Yf(e),c=Zf(e),h=Jf(e),u=Kf(e),d=Qf(e),p=kf(e),g=Vf(r),v=s.createProgram(),m,f,E=e.glslVersion?"#version "+e.glslVersion+`
...
}`,ro=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e,n){if(this.texture===null){let s=new ue,r=t.properties.get(s);r.__webglTexture=e.texture,(e.depthNear!==n.depthNear||e.depthFar!==n.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=s}}getMesh(t){if(this.texture!==null&&this.mesh===null){let e=t.cameras[0].viewport,n=new Fe({vertexShader:xp,fragmentShader:vp,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new Ie(new mn(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},ao=class extends fn{constructor(t,e){super();let n=this,s=null,r=1,a=null,o="local-floor",l=1,c=null,h=null,u=null,d=null,p=null,g=null,v=new ro,m=e.getContextAttributes(),f=null,E=null,w=[],M=[],P=new $t,C=null,A=new Ce;A.viewport=new se;let U=new Ce;U.viewport=new se;let S=[A,U],y=new Ks,I=null,Z=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(q){let st=w[q];return st===void 0&&(st=new _i,w[q]=st),st.getTargetRaySpace()},this.getControllerGrip=function(q){let st=w[q];return st===void 0&&(st=new _i,w[q]=st),st.getGripSpace()},this.getHand=function(q){let st=w[q];return st===void 0&&(st=new _i,w[q]=st),st.getHandSpace()};function z(q){let st=M.indexOf(q.inputSource);if(st===-1)return;let wt=w[st];wt!==void 0&&(wt.update(q.inputSource,q.frame,c||a),wt.dispatchEvent({type:q.type,data:q.inputSource}))}function X(){s.removeEventListener("select",z),s.removeEventListener("selectstart",z),s.removeEventListener("selectend",z),s.removeEventListener("squeeze",z),s.removeEventListener("squeezestart",z),s.removeEventListener("squeezeend",z),s.removeEventListener("end",X),s.removeEventListener("inputsourceschange",j);for(let q=0;q<w.length;q++){let st=M[q];st!==null&&(M[q]=null,w[q].disconnect(st))}I=null,Z=null,v.reset(),t.setRenderTarget(f),p=null,d=null,u=null,s=null,E=null,te.stop(),n.isPresenting=!1,t.setPixelRatio(C),t.setSize(P.width,P.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(q){r=q,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(q){o=q,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(q){c=q},this.getBaseLayer=function(){return d!==null?d:p},this.getBinding=function(){return u},this.getFrame=function(){return g},this.getSession=function(){return s},this.setSession=async function(q){if(s=q,s!==null){if(f=t.getRenderTarget(),s.addEventListener("select",z),s.addEventListener("selectstart",z),s.addEventListener("selectend",z),s.addEventListener("squeeze",z),s.addEventListener("squeezestart",z),s.addEventListener("squeezeend",z),s.addEventListener("end",X),s.addEventListener("inputsourceschange",j),m.xrCompatible!==!0&&await e.makeXRCompatible(),C=t.getPixelRatio(),t.getSize(P),typeof XRWebGLBinding!="undefined"&&"createProjectionLayer"in XRWebGLBinding.prototype){let wt=null,ut=null,Ct=null;m.depth&&(Ct=m.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,wt=m.stencil?wi:fi,ut=m.stencil?bi:Pn);let k={colorFormat:e.RGBA8,depthFormat:Ct,scaleFactor:r};u=new XRWebGLBinding(s,e),d=u.createProjectionLayer(k),s.updateRenderState({layers:[d]}),t.setPixelRatio(1),t.setSize(d.textureWidth,d.textureHeight,!1),E=new Je(d.textureWidth,d.textureHeight,{format:Pe,type:tn,depthTexture:new Yi(d.textureWidth,d.textureHeight,ut,void 0,void 0,void 0,void 0,void 0,void 0,wt),stencilBuffer:m.stencil,colorSpace:t.outputColorSpace,samples:m.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1})}else{let wt={antialias:m.antialias,alpha:!0,depth:m.depth,stencil:m.stencil,framebufferScaleFactor:r};p=new XRWebGLLayer(s,e,wt),s.updateRenderState({baseLayer:p}),t.setPixelRatio(1),t.setSize(p.framebufferWidth,p.framebufferHeight,!1),E=new Je(p.framebufferWidth,p.framebufferHeight,{format:Pe,type:tn,colorSpace:t.outputColorSpace,stencilBuffer:m.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}E.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await s.requestReferenceSpace(o),te.setContext(s),te.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return v.getDepthTexture()};function j(q){for(let st=0;st<q.removed.length;st++){let wt=q.removed[st],ut=M.indexOf(wt);ut>=0&&(M[ut]=null,w[ut].disconnect(wt))}for(let st=0;st<q.added.length;st++){let wt=q.added[st],ut=M.indexOf(wt);if(ut===-1){for(let k=0;k<w.length;k++)if(k>=M.length){M.push(wt),ut=k;break}else if(M[k]===null){M[k]=wt,ut=k;break}if(ut===-1)break}let Ct=w[ut];Ct&&Ct.connect(wt)}}let W=new O,it=new O;function V(q,st,wt){W.setFromMatrixPosition(st.matrixWorld),it.setFromMatrixPosition(wt.matrixWorld);let ut=W.distanceTo(it),Ct=st.projectionMatrix.elements,k=wt.projectionMatrix.elements,G=Ct[14]/(Ct[10]-1),rt=Ct[14]/(Ct[10]+1),pt=(Ct[9]+1)/Ct[5],It=(Ct[9]-1)/Ct[5],T=(Ct[8]-1)/Ct[0],Ht=(k[8]+1)/k[0],Tt=G*T,Gt=G*Ht,ht=ut/(-T+Ht),Ot=ht*-T;if(st.matrixWorld.decompose(q.position,q.quaternion,q.scale),q.translateX(Ot),q.translateZ(ht),q.matrixWorld.compose(q.position,q.quaternion,q.scale),q.matrixWorldInverse.copy(q.matrixWorld).invert(),Ct[10]===-1)q.projectionMatrix.copy(st.projectionMatrix),q.projectionMatrixInverse.copy(st.projectionMatrixInverse);else{let gt=G+ht,Pt=rt+ht,Qt=Tt-Ot,b=Gt+(ut-Ot),_=pt*rt/Pt*gt,N=It*rt/Pt*gt;q.projectionMatrix.makePerspective(Qt,b,_,N,gt,Pt),q.projectionMatrixInverse.copy(q.projectionMatrix).invert()}}function ct(q,st){st===null?q.matrixWorld.copy(q.matrix):q.matrixWorld.multiplyMatrices(st.matrixWorld,q.matrix),q.matrixWorldInverse.copy(q.matrixWorld).invert()}this.updateCamera=function(q){if(s===null)return;let st=q.near,wt=q.far;v.texture!==null&&(v.depthNear>0&&(st=v.depthNear),v.depthFar>0&&(wt=v.depthFar)),y.near=U.near=A.near=st,y.far=U.far=A.far=wt,(I!==y.near||Z!==y.far)&&(s.updateRenderState({depthNear:y.near,depthFar:y.far}),I=y.near,Z=y.far),A.layers.mask=q.layers.mask|2,U.layers.mask=q.layers.mask|4,y.layers.mask=A.layers.mask|U.layers.mask;let ut=q.parent,Ct=y.cameras;ct(y,ut);for(let k=0;k<Ct.length;k++)ct(Ct[k],ut);Ct.length===2?V(y,A,U):y.projectionMatrix.copy(A.projectionMatrix),mt(q,y,ut)};function mt(q,st,wt){wt===null?q.matrix.copy(st.matrixWorld):(q.matrix.copy(wt.matrixWorld),q.matrix.invert(),q.matrix.multiply(st.matrixWorld)),q.matrix.decompose(q.position,q.quaternion,q.scale),q.updateMatrixWorld(!0),q.projectionMatrix.copy(st.projectionMatrix),q.projectionMatrixInverse.copy(st.projectionMatrixInverse),q.isPerspectiveCamera&&(q.fov=Ds*2*Math.atan(1/q.projectionMatrix.elements[5]),q.zoom=1)}this.getCamera=function(){return y},this.getFoveation=function(){if(!(d===null&&p===null))return l},this.setFoveation=function(q){l=q,d!==null&&(d.fixedFoveation=q),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=q)},this.hasDepthSensing=function(){return v.texture!==null},this.getDepthSensingMesh=function(){return v.getMesh(y)};let bt=null;function Vt(q,st){if(h=st.getViewerPose(c||a),g=st,h!==null){let wt=h.views;p!==null&&(t.setRenderTargetFramebuffer(E,p.framebuffer),t.setRenderTarget(E));let ut=!1;wt.length!==y.cameras.length&&(y.cameras.length=0,ut=!0);for(let G=0;G<wt.length;G++){let rt=wt[G],pt=null;if(p!==null)pt=p.getViewport(rt);else{let T=u.getViewSubImage(d,rt);pt=T.viewport,G===0&&(t.setRenderTargetTextures(E,T.colorTexture,T.depthStencilTexture),t.setRenderTarget(E))}let It=S[G];It===void 0&&(It=new Ce,It.layers.enable(G),It.viewport=new se,S[G]=It),It.matrix.fromArray(rt.transform.matrix),It.matrix.decompose(It.position,It.quaternion,It.scale),It.projectionMatrix.fromArray(rt.projectionMatrix),It.projectionMatrixInverse.copy(It.projectionMatrix).invert(),It.viewport.set(pt.x,pt.y,pt.width,pt.height),G===0&&(y.matrix.copy(It.matrix),y.matrix.decompose(y.position,y.quaternion,y.scale)),ut===!0&&y.cameras.push(It)}let Ct=s.enabledFeatures;if(Ct&&Ct.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&u){let G=u.getDepthInformation(wt[0]);G&&G.isValid&&G.texture&&v.init(t,G,s.renderState)}}for(let wt=0;wt<w.length;wt++){let ut=M[wt],Ct=w[wt];ut!==null&&Ct!==void 0&&Ct.update(ut,st,c||a)}bt&&bt(q,st),st.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:st}),g=null}let te=new tc;te.setAnimationLoop(Vt),this.setAnimationLoop=function(q){bt=q},this.dispose=function(){}}},Jn=new Ve,yp=new le;function Mp(i,t){function e(m,f){m.matrixAutoUpdate===!0&&m.updateMatrix(),f.value.copy(m.matrix)}function n(m,f){f.color.getRGB(m.fogColor.value,Ga(i)),f.isFog?(m.fogNear.value=f.near,m.fogFar.value=f.far):f.isFogExp2&&(m.fogDensity.value=f.density)}function s(m,f,E,w,M){f.isMeshBasicMaterial||f.isMeshLambertMaterial?r(m,f):f.isMeshToonMaterial?(r(m,f),u(m,f)):f.isMeshPhongMaterial?(r(m,f),h(m,f)):f.isMeshStandardMaterial?(r(m,f),d(m,f),f.isMeshPhysicalMaterial&&p(m,f,M)):f.isMeshMatcapMaterial?(r(m,f),g(m,f)):f.isMeshDepthMaterial?r(m,f):f.isMeshDistanceMaterial?(r(m,f),v(m,f)):f.isMeshNormalMaterial?r(m,f):f.isLineBasicMaterial?(a(m,f),f.isLineDashedMaterial&&o(m,f)):f.isPointsMaterial?l(m,f,E,w):f.isSpriteMaterial?c(m,f):f.isShadowMaterial?(m.color.value.copy(f.color),m.opacity.value=f.opacity):f.isShaderMaterial&&(f.uniformsNeedUpdate=!1)}function r(m,f){m.opacity.value=f.opacity,f.color&&m.diffuse.value.copy(f.color),f.emissive&&m.emissive.value.copy(f.emissive).multiplyScalar(f.emissiveIntensity),f.map&&(m.map.value=f.map,e(f.map,m.mapTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,e(f.alphaMap,m.alphaMapTransform)),f.bumpMap&&(m.bumpMap.value=f.bumpMap,e(f.bumpMap,m.bumpMapTransform),m.bumpScale.value=f.bumpScale,f.side===Te&&(m.bumpScale.value*=-1)),f.normalMap&&(m.normalMap.value=f.normalMap,e(f.normalMap,m.normalMapTransform),m.normalScale.value.copy(f.normalScale),f.side===Te&&m.normalScale.value.negate()),f.displacementMap&&(m.displacementMap.value=f.displacementMap,e(f.displacementMap,m.displacementMapTransform),m.displacementScale.value=f.displacementScale,m.displacementBias.value=f.displacementBias),f.emissiveMap&&(m.emissiveMap.value=f.emissiveMap,e(f.emissiveMap,m.emissiveMapTransform)),f.specularMap&&(m.specularMap.value=f.specularMap,e(f.specularMap,m.specularMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest);let E=t.get(f),w=E.envMap,M=E.envMapRotation;w&&(m.envMap.value=w,Jn.copy(M),Jn.x*=-1,Jn.y*=-1,Jn.z*=-1,w.isCubeTexture&&w.isRenderTargetTexture===!1&&(Jn.y*=-1,Jn.z*=-1),m.envMapRotation.value.setFromMatrix4(yp.makeRotationFromEuler(Jn)),m.flipEnvMap.value=w.isCubeTexture&&w.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=f.reflectivity,m.ior.value=f.ior,m.refractionRatio.value=f.refractionRatio),f.lightMap&&(m.lightMap.value=f.lightMap,m.lightMapIntensity.value=f.lightMapIntensity,e(f.lightMap,m.lightMapTransform)),f.aoMap&&(m.aoMap.value=f.aoMap,m.aoMapIntensity.value=f.aoMapIntensity,e(f.aoMap,m.aoMapTransform))}function a(m,f){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,f.map&&(m.map.value=f.map,e(f.map,m.mapTransform))}function o(m,f){m.dashSize.value=f.dashSize,m.totalSize.value=f.dashSize+f.gapSize,m.scale.value=f.scale}function l(m,f,E,w){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,m.size.value=f.size*E,m.scale.value=w*.5,f.map&&(m.map.value=f.map,e(f.map,m.uvTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,e(f.alphaMap,m.alphaMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest)}function c(m,f){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,m.rotation.value=f.rotation,f.map&&(m.map.value=f.map,e(f.map,m.mapTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,e(f.alphaMap,m.alphaMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest)}function h(m,f){m.specular.value.copy(f.specular),m.shininess.value=Math.max(f.shininess,1e-4)}function u(m,f){f.gradientMap&&(m.gradientMap.value=f.gradientMap)}function d(m,f){m.metalness.value=f.metalness,f.metalnessMap&&(m.metalnessMap.value=f.metalnessMap,e(f.metalnessMap,m.metalnessMapTransform)),m.roughness.value=f.roughness,f.roughnessMap&&(m.roughnessMap.value=f.roughnessMap,e(f.roughnessMap,m.roughnessMapTransform)),f.envMap&&(m.envMapIntensity.value=f.envMapIntensity)}function p(m,f,E){m.ior.value=f.ior,f.sheen>0&&(m.sheenColor.value.copy(f.sheenColor).multiplyScalar(f.sheen),m.sheenRoughness.value=f.sheenRoughness,f.sheenColorMap&&(m.sheenColorMap.value=f.sheenColorMap,e(f.sheenColorMap,m.sheenColorMapTransform)),f.sheenRoughnessMap&&(m.sheenRoughnessMap.value=f.sheenRoughnessMap,e(f.sheenRoughnessMap,m.sheenRoughnessMapTransform))),f.clearcoat>0&&(m.clearcoat.value=f.clearcoat,m.clearcoatRoughness.value=f.clearcoatRoughness,f.clearcoatMap&&(m.clearcoatMap.value=f.clearcoatMap,e(f.clearcoatMap,m.clearcoatMapTransform)),f.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=f.clearcoatRoughnessMap,e(f.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),f.clearcoatNormalMap&&(m.clearcoatNormalMap.value=f.clearcoatNormalMap,e(f.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(f.clearcoatNormalScale),f.side===Te&&m.clearcoatNormalScale.value.negate())),f.dispersion>0&&(m.dispersion.value=f.dispersion),f.iridescence>0&&(m.iridescence.value=f.iridescence,m.iridescenceIOR.value=f.iridescenceIOR,m.iridescenceThicknessMinimum.value=f.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=f.iridescenceThicknessRange[1],f.iridescenceMap&&(m.iridescenceMap.value=f.iridescenceMap,e(f.iridescenceMap,m.iridescenceMapTransform)),f.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=f.iridescenceThicknessMap,e(f.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),f.transmission>0&&(m.transmission.value=f.transmission,m.transmissionSamplerMap.value=E.texture,m.transmissionSamplerSize.value.set(E.width,E.height),f.transmissionMap&&(m.transmissionMap.value=f.transmissionMap,e(f.transmissionMap,m.transmissionMapTransform)),m.thickness.value=f.thickness,f.thicknessMap&&(m.thicknessMap.value=f.thicknessMap,e(f.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=f.attenuationDistance,m.attenuationColor.value.copy(f.attenuationColor)),f.anisotropy>0&&(m.anisotropyVector.value.set(f.anisotropy*Math.cos(f.anisotropyRotation),f.anisotropy*Math.sin(f.anisotropyRotation)),f.anisotropyMap&&(m.anisotropyMap.value=f.anisotropyMap,e(f.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=f.specularIntensity,m.specularColor.value.copy(f.specularColor),f.specularColorMap&&(m.specularColorMap.value=f.specularColorMap,e(f.specularColorMap,m.specularColorMapTransform)),f.specularIntensityMap&&(m.specularIntensityMap.value=f.specularIntensityMap,e(f.specularIntensityMap,m.specularIntensityMapTransform))}function g(m,f){f.matcap&&(m.matcap.value=f.matcap)}function v(m,f){let E=t.get(f).light;m.referencePosition.value.setFromMatrixPosition(E.matrixWorld),m.nearDistance.value=E.shadow.camera.near,m.farDistance.value=E.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:s}}function Sp(i,t,e,n){let s={},r={},a=[],o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function l(E,w){let M=w.program;n.uniformBlockBinding(E,M)}function c(E,w){let M=s[E.id];M===void 0&&(g(E),M=h(E),s[E.id]=M,E.addEventListener("dispose",m));let P=w.program;n.updateUBOMapping(E,P);let C=t.render.frame;r[E.id]!==C&&(d(E),r[E.id]=C)}function h(E){let w=u();E.__bindingPointIndex=w;let M=i.createBuffer(),P=E.__size,C=E.usage;return i.bindBuffer(i.UNIFORM_BUFFER,M),i.bufferData(i.UNIFORM_BUFFER,P,C),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,w,M),M}function u(){for(let E=0;E<o;E++)if(a.indexOf(E)===-1)return a.push(E),E;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(E){let w=s[E.id],M=E.uniforms,P=E.__cache;i.bindBuffer(i.UNIFORM_BUFFER,w);for(let C=0,A=M.length;C<A;C++){let U=Array.isArray(M[C])?M[C]:[M[C]];for(let S=0,y=U.length;S<y;S++){let I=U[S];if(p(I,C,S,P)===!0){let Z=I.__offset,z=Array.isArray(I.value)?I.value:[I.value],X=0;for(let j=0;j<z.length;j++){let W=z[j],it=v(W);typeof W=="number"||typeof W=="boolean"?(I.__data[0]=W,i.bufferSubData(i.UNIFORM_BUFFER,Z+X,I.__data)):W.isMatrix3?(I.__data[0]=W.elements[0],I.__data[1]=W.elements[1],I.__data[2]=W.elements[2],I.__data[3]=0,I.__data[4]=W.elements[3],I.__data[5]=W.elements[4],I.__data[6]=W.elements[5],I.__data[7]=0,I.__data[8]=W.elements[6],I.__data[9]=W.elements[7],I.__data[10]=W.elements[8],I.__data[11]=0):(W.toArray(I.__data,X),X+=it.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,Z,I.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function p(E,w,M,P){let C=E.value,A=w+"_"+M;if(P[A]===void 0)return typeof C=="number"||typeof C=="boolean"?P[A]=C:P[A]=C.clone(),!0;{let U=P[A];if(typeof C=="number"||typeof C=="boolean"){if(U!==C)return P[A]=C,!0}else if(U.equals(C)===!1)return U.copy(C),!0}return!1}function g(E){let w=E.uniforms,M=0,P=16;for(let A=0,U=w.length;A<U;A++){let S=Array.isArray(w[A])?w[A]:[w[A]];for(let y=0,I=S.length;y<I;y++){let Z=S[y],z=Array.isArray(Z.value)?Z.value:[Z.value];for(let X=0,j=z.length;X<j;X++){let W=z[X],it=v(W),V=M%P,ct=V%it.boundary,mt=V+ct;M+=ct,mt!==0&&P-mt<it.storage&&(M+=P-mt),Z.__data=new Float32Array(it.storage/Float32Array.BYTES_PER_ELEMENT),Z.__offset=M,M+=it.storage}}}let C=M%P;return C>0&&(M+=P-C),E.__size=M,E.__cache={},this}function v(E){let w={boundary:0,storage:0};return typeof E=="number"||typeof E=="boolean"?(w.boundary=4,w.storage=4):E.isVector2?(w.boundary=8,w.storage=8):E.isVector3||E.isColor?(w.boundary=16,w.storage=12):E.isVector4?(w.boundary=16,w.storage=16):E.isMatrix3?(w.boundary=48,w.storage=48):E.isMatrix4?(w.boundary=64,w.storage=64):E.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",E),w}function m(E){let w=E.target;w.removeEventListener("dispose",m);let M=a.indexOf(w.__bindingPointIndex);a.splice(M,1),i.deleteBuffer(s[w.id]),delete s[w.id],delete r[w.id]}function f(){for(let E in s)i.deleteBuffer(s[E]);a=[],s={},r={}}return{bind:l,update:c,dispose:f}}var Xr=class{constructor(t={}){let{canvas:e=wl(),context:n=null,depth:s=!0,stencil:r=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:u=!1,reverseDepthBuffer:d=!1}=t;this.isWebGLRenderer=!0;let p;if(n!==null){if(typeof WebGLRenderingContext!="undefined"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");p=n.getContextAttributes().alpha}else p=a;let g=new Uint32Array(4),v=new Int32Array(4),m=null,f=null,E=[],w=[];this.domElement=e,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=_n,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let M=this,P=!1;this._outputColorSpace=Se;let C=0,A=0,U=null,S=-1,y=null,I=new se,Z=new se,z=null,X=new Zt(0),j=0,W=e.width,it=e.height,V=1,ct=null,mt=null,bt=new se(0,0,W,it),Vt=new se(0,0,W,it),te=!1,q=new $i,st=!1,wt=!1,ut=new le,Ct=new le,k=new O,G=new se,rt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},pt=!1;function It(){return U===null?V:1}let T=n;function Ht(x,L){return e.getContext(x,L)}try{let x={alpha:!0,depth:s,stencil:r,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:h,failIfMajorPerformanceCaveat:u};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${Qs}`),e.addEventListener("webglcontextlost",vt,!1),e.addEventListener("webglcontextrestored",et,!1),e.addEventListener("webglcontextcreationerror",J,!1),T===null){let L="webgl2";if(T=Ht(L,x),T===null)throw Ht(L)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(x){throw console.error("THREE.WebGLRenderer: "+x.message),x}let Tt,Gt,ht,Ot,gt,Pt,Qt,b,_,N,Y,K,H,Et,lt,St,At,Q,_t,Ut,Dt,at,Bt,R;function dt(){Tt=new zd(T),Tt.init(),at=new _p(T,Tt),Gt=new Ld(T,Tt,t,at),ht=new mp(T,Tt),Gt.reverseDepthBuffer&&d&&ht.buffers.depth.setReversed(!0),Ot=new Hd(T),gt=new np,Pt=new gp(T,Tt,ht,gt,Gt,at,Ot),Qt=new Ud(M),b=new Bd(M),_=new Yc(T),Bt=new Id(T,_),N=new kd(T,_,Ot,Bt),Y=new Wd(T,N,_,Ot),_t=new Gd(T,Gt,Pt),St=new Dd(gt),K=new ep(M,Qt,b,Tt,Gt,Bt,St),H=new Mp(M,gt),Et=new sp,lt=new hp(Tt),Q=new Rd(M,Qt,b,ht,Y,p,l),At=new fp(M,Y,Gt),R=new Sp(T,Ot,Gt,ht),Ut=new Pd(T,Tt,Ot),Dt=new Vd(T,Tt,Ot),Ot.programs=K.programs,M.capabilities=Gt,M.extensions=Tt,M.properties=gt,M.renderLists=Et,M.shadowMap=At,M.state=ht,M.info=Ot}dt();let tt=new ao(M,T);this.xr=tt,this.getContext=function(){return T},this.getContextAttributes=function(){return T.getContextAttributes()},this.forceContextLoss=function(){let x=Tt.get("WEBGL_lose_context");x&&x.loseContext()},this.forceContextRestore=function(){let x=Tt.get("WEBGL_lose_context");x&&x.restoreContext()},this.getPixelRatio=function(){return V},this.setPixelRatio=function(x){x!==void 0&&(V=x,this.setSize(W,it,!1))},this.getSize=function(x){return x.set(W,it)},this.setSize=function(x,L,F=!0){if(tt.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}W=x,it=L,e.width=Math.floor(x*V),e.height=Math.floor(L*V),F===!0&&(e.style.width=x+"px",e.style.height=L+"px"),this.setViewport(0,0,x,L)},this.getDrawingBufferSize=function(x){return x.set(W*V,it*V).floor()},this.setDrawingBufferSize=function(x,L,F){W=x,it=L,V=F,e.width=Math.floor(x*F),e.height=Math.floor(L*F),this.setViewport(0,0,x,L)},this.getCurrentViewport=function(x){return x.copy(I)},this.getViewport=function(x){return x.copy(bt)},this.setViewport=function(x,L,F,B){x.isVector4?bt.set(x.x,x.y,x.z,x.w):bt.set(x,L,F,B),ht.viewport(I.copy(bt).multiplyScalar(V).round())},this.getScissor=function(x){return x.copy(Vt)},this.setScissor=function(x,L,F,B){x.isVector4?Vt.set(x.x,x.y,x.z,x.w):Vt.set(x,L,F,B),ht.scissor(Z.copy(Vt).multiplyScalar(V).round())},this.getScissorTest=function(){return te},this.setScissorTest=function(x){ht.setScissorTest(te=x)},this.setOpaqueSort=function(x){ct=x},this.setTransparentSort=function(x){mt=x},this.getClearColor=function(x){return x.copy(Q.getClearColor())},this.setClearColor=function(){Q.setClearColor(...arguments)},this.getClearAlpha=function(){return Q.getClearAlpha()},this.setClearAlpha=function(){Q.setClearAlpha(...arguments)},this.clear=function(x=!0,L=!0,F=!0){let B=0;if(x){let D=!1;if(U!==null){let nt=U.texture.format;D=nt===pr||nt===fr||nt===dr}if(D){let nt=U.texture.type,ft=nt===tn||nt===Pn||nt===Mi||nt===bi||nt===hr||nt===ur,Mt=Q.getClearColor(),xt=Q.getClearAlpha(),Nt=Mt.r,Ft=Mt.g,Rt=Mt.b;ft?(g[0]=Nt,g[1]=Ft,g[2]=Rt,g[3]=xt,T.clearBufferuiv(T.COLOR,0,g)):(v[0]=Nt,v[1]=Ft,v[2]=Rt,v[3]=xt,T.clearBufferiv(T.COLOR,0,v))}else B|=T.COLOR_BUFFER_BIT}L&&(B|=T.DEPTH_BUFFER_BIT),F&&(B|=T.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),T.clear(B)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){e.removeEventListener("webglcontextlost",vt,!1),e.removeEventListener("webglcontextrestored",et,!1),e.removeEventListener("webglcontextcreationerror",J,!1),Q.dispose(),Et.dispose(),lt.dispose(),gt.dispose(),Qt.dispose(),b.dispose(),Y.dispose(),Bt.dispose(),R.dispose(),K.dispose(),tt.dispose(),tt.removeEventListener("sessionstart",uo),tt.removeEventListener("sessionend",fo),Ln.stop()};function vt(x){x.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),P=!0}function et(){console.log("THREE.WebGLRenderer: Context Restored."),P=!1;let x=Ot.autoReset,L=At.enabled,F=At.autoUpdate,B=At.needsUpdate,D=At.type;dt(),Ot.autoReset=x,At.enabled=L,At.autoUpdate=F,At.needsUpdate=B,At.type=D}function J(x){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",x.statusMessage)}function yt(x){let L=x.target;L.removeEventListener("dispose",yt),kt(L)}function kt(x){re(x),gt.remove(x)}function re(x){let L=gt.get(x).programs;L!==void 0&&(L.forEach(function(F){K.releaseProgram(F)}),x.isShaderMaterial&&K.releaseShaderCache(x))}this.renderBufferDirect=function(x,L,F,B,D,nt){L===null&&(L=rt);let ft=D.isMesh&&D.matrixWorld.determinant()<0,Mt=uc(x,L,F,B,D);ht.setMaterial(B,ft);let xt=F.index,Nt=1;if(B.wireframe===!0){if(xt=N.getWireframeAttribute(F),xt===void 0)return;Nt=2}let Ft=F.drawRange,Rt=F.attributes.position,Xt=Ft.start*Nt,ne=(Ft.start+Ft.count)*Nt;nt!==null&&(Xt=Math.max(Xt,nt.start*Nt),ne=Math.min(ne,(nt.start+nt.count)*Nt)),xt!==null?(Xt=Math.max(Xt,0),ne=Math.min(ne,xt.count)):Rt!=null&&(Xt=Math.max(Xt,0),ne=Math.min(ne,Rt.count));let oe=ne-Xt;if(oe<0||oe===1/0)return;Bt.setup(D,B,Mt,F,xt);let ce,Jt=Ut;if(xt!==null&&(ce=_.get(xt),Jt=Dt,Jt.setIndex(ce)),D.isMesh)B.wireframe===!0?(ht.setLineWidth(B.wireframeLinewidth*It()),Jt.setMode(T.LINES)):Jt.setMode(T.TRIANGLES);else if(D.isLine){let Lt=B.linewidth;Lt===void 0&&(Lt=1),ht.setLineWidth(Lt*It()),D.isLineSegments?Jt.setMode(T.LINES):D.isLineLoop?Jt.setMode(T.LINE_LOOP):Jt.setMode(T.LINE_STRIP)}else D.isPoints?Jt.setMode(T.POINTS):D.isSprite&&Jt.setMode(T.TRIANGLES);if(D.isBatchedMesh)if(D._multiDrawInstances!==null)Gn("THREE.WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),Jt.renderMultiDrawInstances(D._multiDrawStarts,D._multiDrawCounts,D._multiDrawCount,D._multiDrawInstances);else if(Tt.get("WEBGL_multi_draw"))Jt.renderMultiDraw(D._multiDrawStarts,D._multiDrawCounts,D._multiDrawCount);else{let Lt=D._multiDrawStarts,me=D._multiDrawCounts,jt=D._multiDrawCount,Ge=xt?_.get(xt).bytesPerElement:1,jn=gt.get(B).currentProgram.getUniforms();for(let Le=0;Le<jt;Le++)jn.setValue(T,"_gl_DrawID",Le),Jt.render(Lt[Le]/Ge,me[Le])}else if(D.isInstancedMesh)Jt.renderInstances(Xt,oe,D.count);else if(F.isInstancedBufferGeometry){let Lt=F._maxInstanceCount!==void 0?F._maxInstanceCount:1/0,me=Math.min(F.instanceCount,Lt);Jt.renderInstances(Xt,oe,me)}else Jt.render(Xt,oe)};function ee(x,L,F){x.transparent===!0&&x.side===je&&x.forceSinglePass===!1?(x.side=Te,x.needsUpdate=!0,ls(x,L,F),x.side=dn,x.needsUpdate=!0,ls(x,L,F),x.side=je):ls(x,L,F)}this.compile=function(x,L,F=null){F===null&&(F=x),f=lt.get(F),f.init(L),w.push(f),F.traverseVisible(function(D){D.isLight&&D.layers.test(L.layers)&&(f.pushLight(D),D.castShadow&&f.pushShadow(D))}),x!==F&&x.traverseVisible(function(D){D.isLight&&D.layers.test(L.layers)&&(f.pushLight(D),D.castShadow&&f.pushShadow(D))}),f.setupLights();let B=new Set;return x.traverse(function(D){if(!(D.isMesh||D.isPoints||D.isLine||D.isSprite))return;let nt=D.material;if(nt)if(Array.isArray(nt))for(let ft=0;ft<nt.length;ft++){let Mt=nt[ft];ee(Mt,F,D),B.add(Mt)}else ee(nt,F,D),B.add(nt)}),f=w.pop(),B},this.compileAsync=function(x,L,F=null){let B=this.compile(x,L,F);return new Promise(D=>{function nt(){if(B.forEach(function(ft){gt.get(ft).currentProgram.isReady()&&B.delete(ft)}),B.size===0){D(x);return}setTimeout(nt,10)}Tt.get("KHR_parallel_shader_compile")!==null?nt():setTimeout(nt,10)})};let He=null;function rn(x){He&&He(x)}function uo(){Ln.stop()}function fo(){Ln.start()}let Ln=new tc;Ln.setAnimationLoop(rn),typeof self!="undefined"&&Ln.setContext(self),this.setAnimationLoop=function(x){He=x,tt.setAnimationLoop(x),x===null?Ln.stop():Ln.start()},tt.addEventListener("sessionstart",uo),tt.addEventListener("sessionend",fo),this.render=function(x,L){if(L!==void 0&&L.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(P===!0)return;if(x.matrixWorldAutoUpdate===!0&&x.updateMatrixWorld(),L.parent===null&&L.matrixWorldAutoUpdate===!0&&L.updateMatrixWorld(),tt.enabled===!0&&tt.isPresenting===!0&&(tt.cameraAutoUpdate===!0&&tt.updateCamera(L),L=tt.getCamera()),x.isScene===!0&&x.onBeforeRender(M,x,L,U),f=lt.get(x,w.length),f.init(L),w.push(f),Ct.multiplyMatrices(L.projectionMatrix,L.matrixWorldInverse),q.setFromProjectionMatrix(Ct),wt=this.localClippingEnabled,st=St.init(this.clippingPlanes,wt),m=Et.get(x,E.length),m.init(),E.push(m),tt.enabled===!0&&tt.isPresenting===!0){let nt=M.xr.getDepthSensingMesh();nt!==null&&$r(nt,L,-1/0,M.sortObjects)}$r(x,L,0,M.sortObjects),m.finish(),M.sortObjects===!0&&m.sort(ct,mt),pt=tt.enabled===!1||tt.isPresenting===!1||tt.hasDepthSensing()===!1,pt&&Q.addToRenderList(m,x),this.info.render.frame++,st===!0&&St.beginShadows();let F=f.state.shadowsArray;At.render(F,x,L),st===!0&&St.endShadows(),this.info.autoReset===!0&&this.info.reset();let B=m.opaque,D=m.transmissive;if(f.setupLights(),L.isArrayCamera){let nt=L.cameras;if(D.length>0)for(let ft=0,Mt=nt.length;ft<Mt;ft++){let xt=nt[ft];mo(B,D,x,xt)}pt&&Q.render(x);for(let ft=0,Mt=nt.length;ft<Mt;ft++){let xt=nt[ft];po(m,x,xt,xt.viewport)}}else D.length>0&&mo(B,D,x,L),pt&&Q.render(x),po(m,x,L);U!==null&&A===0&&(Pt.updateMultisampleRenderTarget(U),Pt.updateRenderTargetMipmap(U)),x.isScene===!0&&x.onAfterRender(M,x,L),Bt.resetDefaultState(),S=-1,y=null,w.pop(),w.length>0?(f=w[w.length-1],st===!0&&St.setGlobalState(M.clippingPlanes,f.state.camera)):f=null,E.pop(),E.length>0?m=E[E.length-1]:m=null};function $r(x,L,F,B){if(x.visible===!1)return;if(x.layers.test(L.layers)){if(x.isGroup)F=x.renderOrder;else if(x.isLOD)x.autoUpdate===!0&&x.update(L);else if(x.isLight)f.pushLight(x),x.castShadow&&f.pushShadow(x);else if(x.isSprite){if(!x.frustumCulled||q.intersectsSprite(x)){B&&G.setFromMatrixPosition(x.matrixWorld).applyMatrix4(Ct);let ft=Y.update(x),Mt=x.material;Mt.visible&&m.push(x,ft,Mt,F,G.z,null)}}else if((x.isMesh||x.isLine||x.isPoints)&&(!x.frustumCulled||q.intersectsObject(x))){let ft=Y.update(x),Mt=x.material;if(B&&(x.boundingSphere!==void 0?(x.boundingSphere===null&&x.computeBoundingSphere(),G.copy(x.boundingSphere.center)):(ft.boundingSphere===null&&ft.computeBoundingSphere(),G.copy(ft.boundingSphere.center)),G.applyMatrix4(x.matrixWorld).applyMatrix4(Ct)),Array.isArray(Mt)){let xt=ft.groups;for(let Nt=0,Ft=xt.length;Nt<Ft;Nt++){let Rt=xt[Nt],Xt=Mt[Rt.materialIndex];Xt&&Xt.visible&&m.push(x,ft,Xt,F,G.z,Rt)}}else Mt.visible&&m.push(x,ft,Mt,F,G.z,null)}}let nt=x.children;for(let ft=0,Mt=nt.length;ft<Mt;ft++)$r(nt[ft],L,F,B)}function po(x,L,F,B){let D=x.opaque,nt=x.transmissive,ft=x.transparent;f.setupLightsView(F),st===!0&&St.setGlobalState(M.clippingPlanes,F),B&&ht.viewport(I.copy(B)),D.length>0&&os(D,L,F),nt.length>0&&os(nt,L,F),ft.length>0&&os(ft,L,F),ht.buffers.depth.setTest(!0),ht.buffers.depth.setMask(!0),ht.buffers.color.setMask(!0),ht.setPolygonOffset(!1)}function mo(x,L,F,B){if((F.isScene===!0?F.overrideMaterial:null)!==null)return;f.state.transmissionRenderTarget[B.id]===void 0&&(f.state.transmissionRenderTarget[B.id]=new Je(1,1,{generateMipmaps:!0,type:Tt.has("EXT_color_buffer_half_float")||Tt.has("EXT_color_buffer_float")?Si:tn,minFilter:In,samples:4,stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Yt.workingColorSpace}));let nt=f.state.transmissionRenderTarget[B.id],ft=B.viewport||I;nt.setSize(ft.z*M.transmissionResolutionScale,ft.w*M.transmissionResolutionScale);let Mt=M.getRenderTarget();M.setRenderTarget(nt),M.getClearColor(X),j=M.getClearAlpha(),j<1&&M.setClearColor(16777215,.5),M.clear(),pt&&Q.render(F);let xt=M.toneMapping;M.toneMapping=_n;let Nt=B.viewport;if(B.viewport!==void 0&&(B.viewport=void 0),f.setupLightsView(B),st===!0&&St.setGlobalState(M.clippingPlanes,B),os(x,F,B),Pt.updateMultisampleRenderTarget(nt),Pt.updateRenderTargetMipmap(nt),Tt.has("WEBGL_multisampled_render_to_texture")===!1){let Ft=!1;for(let Rt=0,Xt=L.length;Rt<Xt;Rt++){let ne=L[Rt],oe=ne.object,ce=ne.geometry,Jt=ne.material,Lt=ne.group;if(Jt.side===je&&oe.layers.test(B.layers)){let me=Jt.side;Jt.side=Te,Jt.needsUpdate=!0,go(oe,F,B,ce,Jt,Lt),Jt.side=me,Jt.needsUpdate=!0,Ft=!0}}Ft===!0&&(Pt.updateMultisampleRenderTarget(nt),Pt.updateRenderTargetMipmap(nt))}M.setRenderTarget(Mt),M.setClearColor(X,j),Nt!==void 0&&(B.viewport=Nt),M.toneMapping=xt}function os(x,L,F){let B=L.isScene===!0?L.overrideMaterial:null;for(let D=0,nt=x.length;D<nt;D++){let ft=x[D],Mt=ft.object,xt=ft.geometry,Nt=ft.group,Ft=ft.material;Ft.allowOverride===!0&&B!==null&&(Ft=B),Mt.layers.test(F.layers)&&go(Mt,L,F,xt,Ft,Nt)}}function go(x,L,F,B,D,nt){x.onBeforeRender(M,L,F,B,D,nt),x.modelViewMatrix.multiplyMatrices(F.matrixWorldInverse,x.matrixWorld),x.normalMatrix.getNormalMatrix(x.modelViewMatrix),D.onBeforeRender(M,L,F,B,x,nt),D.transparent===!0&&D.side===je&&D.forceSinglePass===!1?(D.side=Te,D.needsUpdate=!0,M.renderBufferDirect(F,L,B,D,x,nt),D.side=dn,D.needsUpdate=!0,M.renderBufferDirect(F,L,B,D,x,nt),D.side=je):M.renderBufferDirect(F,L,B,D,x,nt),x.onAfterRender(M,L,F,B,D,nt)}function ls(x,L,F){L.isScene!==!0&&(L=rt);let B=gt.get(x),D=f.state.lights,nt=f.state.shadowsArray,ft=D.state.version,Mt=K.getParameters(x,D.state,nt,L,F),xt=K.getProgramCacheKey(Mt),Nt=B.programs;B.environment=x.isMeshStandardMaterial?L.environment:null,B.fog=L.fog,B.envMap=(x.isMeshStandardMaterial?b:Qt).get(x.envMap||B.environment),B.envMapRotation=B.environment!==null&&x.envMap===null?L.environmentRotation:x.envMapRotation,Nt===void 0&&(x.addEventListener("dispose",yt),Nt=new Map,B.programs=Nt);let Ft=Nt.get(xt);if(Ft!==void 0){if(B.currentProgram===Ft&&B.lightsStateVersion===ft)return xo(x,Mt),Ft}else Mt.uniforms=K.getUniforms(x),x.onBeforeCompile(Mt,M),Ft=K.acquireProgram(Mt,xt),Nt.set(xt,Ft),B.uniforms=Mt.uniforms;let Rt=B.uniforms;return(!x.isShaderMaterial&&!x.isRawShaderMaterial||x.clipping===!0)&&(Rt.clippingPlanes=St.uniform),xo(x,Mt),B.needsLights=fc(x),B.lightsStateVersion=ft,B.needsLights&&(Rt.ambientLightColor.value=D.state.ambient,Rt.lightProbe.value=D.state.probe,Rt.directionalLights.value=D.state.directional,Rt.directionalLightShadows.value=D.state.directionalShadow,Rt.spotLights.value=D.state.spot,Rt.spotLightShadows.value=D.state.spotShadow,Rt.rectAreaLights.value=D.state.rectArea,Rt.ltc_1.value=D.state.rectAreaLTC1,Rt.ltc_2.value=D.state.rectAreaLTC2,Rt.pointLights.value=D.state.point,Rt.pointLightShadows.value=D.state.pointShadow,Rt.hemisphereLights.value=D.state.hemi,Rt.directionalShadowMap.value=D.state.directionalShadowMap,Rt.directionalShadowMatrix.value=D.state.directionalShadowMatrix,Rt.spotShadowMap.value=D.state.spotShadowMap,Rt.spotLightMatrix.value=D.state.spotLightMatrix,Rt.spotLightMap.value=D.state.spotLightMap,Rt.pointShadowMap.value=D.state.pointShadowMap,Rt.pointShadowMatrix.value=D.state.pointShadowMatrix),B.currentProgram=Ft,B.uniformsList=null,Ft}function _o(x){if(x.uniformsList===null){let L=x.currentProgram.getUniforms();x.uniformsList=Ai.seqWithValue(L.seq,x.uniforms)}return x.uniformsList}function xo(x,L){let F=gt.get(x);F.outputColorSpace=L.outputColorSpace,F.batching=L.batching,F.batchingColor=L.batchingColor,F.instancing=L.instancing,F.instancingColor=L.instancingColor,F.instancingMorph=L.instancingMorph,F.skinning=L.skinning,F.morphTargets=L.morphTargets,F.morphNormals=L.morphNormals,F.morphColors=L.morphColors,F.morphTargetsCount=L.morphTargetsCount,F.numClippingPlanes=L.numClippingPlanes,F.numIntersection=L.numClipIntersection,F.vertexAlphas=L.vertexAlphas,F.vertexTangents=L.vertexTangents,F.toneMapping=L.toneMapping}function uc(x,L,F,B,D){L.isScene!==!0&&(L=rt),Pt.resetTextureUnits();let nt=L.fog,ft=B.isMeshStandardMaterial?L.environment:null,Mt=U===null?M.outputColorSpace:U.isXRRenderTarget===!0?U.texture.colorSpace:Hn,xt=(B.isMeshStandardMaterial?b:Qt).get(B.envMap||ft),Nt=B.vertexColors===!0&&!!F.attributes.color&&F.attributes.color.itemSize===4,Ft=!!F.attributes.tangent&&(!!B.normalMap||B.anisotropy>0),Rt=!!F.morphAttributes.position,Xt=!!F.morphAttributes.normal,ne=!!F.morphAttributes.color,oe=_n;B.toneMapped&&(U===null||U.isXRRenderTarget===!0)&&(oe=M.toneMapping);let ce=F.morphAttributes.position||F.morphAttributes.normal||F.morphAttributes.color,Jt=ce!==void 0?ce.length:0,Lt=gt.get(B),me=f.state.lights;if(st===!0&&(wt===!0||x!==y)){let Me=x===y&&B.id===S;St.setState(B,x,Me)}let jt=!1;B.version===Lt.__version?(Lt.needsLights&&Lt.lightsStateVersion!==me.state.version||Lt.outputColorSpace!==Mt||D.isBatchedMesh&&Lt.batching===!1||!D.isBatchedMesh&&Lt.batching===!0||D.isBatchedMesh&&Lt.batchingColor===!0&&D.colorTexture===null||D.isBatchedMesh&&Lt.batchingColor===!1&&D.colorTexture!==null||D.isInstancedMesh&&Lt.instancing===!1||!D.isInstancedMesh&&Lt.instancing===!0||D.isSkinnedMesh&&Lt.skinning===!1||!D.isSkinnedMesh&&Lt.skinning===!0||D.isInstancedMesh&&Lt.instancingColor===!0&&D.instanceColor===null||D.isInstancedMesh&&Lt.instancingColor===!1&&D.instanceColor!==null||D.isInstancedMesh&&Lt.instancingMorph===!0&&D.morphTexture===null||D.isInstancedMesh&&Lt.instancingMorph===!1&&D.morphTexture!==null||Lt.envMap!==xt||B.fog===!0&&Lt.fog!==nt||Lt.numClippingPlanes!==void 0&&(Lt.numClippingPlanes!==St.numPlanes||Lt.numIntersection!==St.numIntersection)||Lt.vertexAlphas!==Nt||Lt.vertexTangents!==Ft||Lt.morphTargets!==Rt||Lt.morphNormals!==Xt||Lt.morphColors!==ne||Lt.toneMapping!==oe||Lt.morphTargetsCount!==Jt)&&(jt=!0):(jt=!0,Lt.__version=B.version);let Ge=Lt.currentProgram;jt===!0&&(Ge=ls(B,L,D));let jn=!1,Le=!1,Ii=!1,ae=Ge.getUniforms(),Be=Lt.uniforms;if(ht.useProgram(Ge.program)&&(jn=!0,Le=!0,Ii=!0),B.id!==S&&(S=B.id,Le=!0),jn||y!==x){ht.buffers.depth.getReversed()?(ut.copy(x.projectionMatrix),El(ut),Al(ut),ae.setValue(T,"projectionMatrix",ut)):ae.setValue(T,"projectionMatrix",x.projectionMatrix),ae.setValue(T,"viewMatrix",x.matrixWorldInverse);let Ee=ae.map.cameraPosition;Ee!==void 0&&Ee.setValue(T,k.setFromMatrixPosition(x.matrixWorld)),Gt.logarithmicDepthBuffer&&ae.setValue(T,"logDepthBufFC",2/(Math.log(x.far+1)/Math.LN2)),(B.isMeshPhongMaterial||B.isMeshToonMaterial||B.isMeshLambertMaterial||B.isMeshBasicMaterial||B.isMeshStandardMaterial||B.isShaderMaterial)&&ae.setValue(T,"isOrthographic",x.isOrthographicCamera===!0),y!==x&&(y=x,Le=!0,Ii=!0)}if(D.isSkinnedMesh){ae.setOptional(T,D,"bindMatrix"),ae.setOptional(T,D,"bindMatrixInverse");let Me=D.skeleton;Me&&(Me.boneTexture===null&&Me.computeBoneTexture(),ae.setValue(T,"boneTexture",Me.boneTexture,Pt))}D.isBatchedMesh&&(ae.setOptional(T,D,"batchingTexture"),ae.setValue(T,"batchingTexture",D._matricesTexture,Pt),ae.setOptional(T,D,"batchingIdTexture"),ae.setValue(T,"batchingIdTexture",D._indirectTexture,Pt),ae.setOptional(T,D,"batchingColorTexture"),D._colorsTexture!==null&&ae.setValue(T,"batchingColorTexture",D._colorsTexture,Pt));let ze=F.morphAttributes;if((ze.position!==void 0||ze.normal!==void 0||ze.color!==void 0)&&_t.update(D,F,Ge),(Le||Lt.receiveShadow!==D.receiveShadow)&&(Lt.receiveShadow=D.receiveShadow,ae.setValue(T,"receiveShadow",D.receiveShadow)),B.isMeshGouraudMaterial&&B.envMap!==null&&(Be.envMap.value=xt,Be.flipEnvMap.value=xt.isCubeTexture&&xt.isRenderTargetTexture===!1?-1:1),B.isMeshStandardMaterial&&B.envMap===null&&L.environment!==null&&(Be.envMapIntensity.value=L.environmentIntensity),Le&&(ae.setValue(T,"toneMappingExposure",M.toneMappingExposure),Lt.needsLights&&dc(Be,Ii),nt&&B.fog===!0&&H.refreshFogUniforms(Be,nt),H.refreshMaterialUniforms(Be,B,V,it,f.state.transmissionRenderTarget[x.id]),Ai.upload(T,_o(Lt),Be,Pt)),B.isShaderMaterial&&B.uniformsNeedUpdate===!0&&(Ai.upload(T,_o(Lt),Be,Pt),B.uniformsNeedUpdate=!1),B.isSpriteMaterial&&ae.setValue(T,"center",D.center),ae.setValue(T,"modelViewMatrix",D.modelViewMatrix),ae.setValue(T,"normalMatrix",D.normalMatrix),ae.setValue(T,"modelMatrix",D.matrixWorld),B.isShaderMaterial||B.isRawShaderMaterial){let Me=B.uniformsGroups;for(let Ee=0,Yr=Me.length;Ee<Yr;Ee++){let Dn=Me[Ee];R.update(Dn,Ge),R.bind(Dn,Ge)}}return Ge}function dc(x,L){x.ambientLightColor.needsUpdate=L,x.lightProbe.needsUpdate=L,x.directionalLights.needsUpdate=L,x.directionalLightShadows.needsUpdate=L,x.pointLights.needsUpdate=L,x.pointLightShadows.needsUpdate=L,x.spotLights.needsUpdate=L,x.spotLightShadows.needsUpdate=L,x.rectAreaLights.needsUpdate=L,x.hemisphereLights.needsUpdate=L}function fc(x){return x.isMeshLambertMaterial||x.isMeshToonMaterial||x.isMeshPhongMaterial||x.isMeshStandardMaterial||x.isShadowMaterial||x.isShaderMaterial&&x.lights===!0}this.getActiveCubeFace=function(){return C},this.getActiveMipmapLevel=function(){return A},this.getRenderTarget=function(){return U},this.setRenderTargetTextures=function(x,L,F){let B=gt.get(x);B.__autoAllocateDepthBuffer=x.resolveDepthBuffer===!1,B.__autoAllocateDepthBuffer===!1&&(B.__useRenderToTexture=!1),gt.get(x.texture).__webglTexture=L,gt.get(x.depthTexture).__webglTexture=B.__autoAllocateDepthBuffer?void 0:F,B.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(x,L){let F=gt.get(x);F.__webglFramebuffer=L,F.__useDefaultFramebuffer=L===void 0};let pc=T.createFramebuffer();this.setRenderTarget=function(x,L=0,F=0){U=x,C=L,A=F;let B=!0,D=null,nt=!1,ft=!1;if(x){let xt=gt.get(x);if(xt.__useDefaultFramebuffer!==void 0)ht.bindFramebuffer(T.FRAMEBUFFER,null),B=!1;else if(xt.__webglFramebuffer===void 0)Pt.setupRenderTarget(x);else if(xt.__hasExternalTextures)Pt.rebindTextures(x,gt.get(x.texture).__webglTexture,gt.get(x.depthTexture).__webglTexture);else if(x.depthBuffer){let Rt=x.depthTexture;if(xt.__boundDepthTexture!==Rt){if(Rt!==null&&gt.has(Rt)&&(x.width!==Rt.image.width||x.height!==Rt.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");Pt.setupDepthRenderbuffer(x)}}let Nt=x.texture;(Nt.isData3DTexture||Nt.isDataArrayTexture||Nt.isCompressedArrayTexture)&&(ft=!0);let Ft=gt.get(x).__webglFramebuffer;x.isWebGLCubeRenderTarget?(Array.isArray(Ft[L])?D=Ft[L][F]:D=Ft[L],nt=!0):x.samples>0&&Pt.useMultisampledRTT(x)===!1?D=gt.get(x).__webglMultisampledFramebuffer:Array.isArray(Ft)?D=Ft[F]:D=Ft,I.copy(x.viewport),Z.copy(x.scissor),z=x.scissorTest}else I.copy(bt).multiplyScalar(V).floor(),Z.copy(Vt).multiplyScalar(V).floor(),z=te;if(F!==0&&(D=pc),ht.bindFramebuffer(T.FRAMEBUFFER,D)&&B&&ht.drawBuffers(x,D),ht.viewport(I),ht.scissor(Z),ht.setScissorTest(z),nt){let xt=gt.get(x.texture);T.framebufferTexture2D(T.FRAMEBUFFER,T.COLOR_ATTACHMENT0,T.TEXTURE_CUBE_MAP_POSITIVE_X+L,xt.__webglTexture,F)}else if(ft){let xt=gt.get(x.texture),Nt=L;T.framebufferTextureLayer(T.FRAMEBUFFER,T.COLOR_ATTACHMENT0,xt.__webglTexture,F,Nt)}else if(x!==null&&F!==0){let xt=gt.get(x.texture);T.framebufferTexture2D(T.FRAMEBUFFER,T.COLOR_ATTACHMENT0,T.TEXTURE_2D,xt.__webglTexture,F)}S=-1},this.readRenderTargetPixels=function(x,L,F,B,D,nt,ft,Mt=0){if(!(x&&x.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let xt=gt.get(x).__webglFramebuffer;if(x.isWebGLCubeRenderTarget&&ft!==void 0&&(xt=xt[ft]),xt){ht.bindFramebuffer(T.FRAMEBUFFER,xt);try{let Nt=x.textures[Mt],Ft=Nt.format,Rt=Nt.type;if(!Gt.textureFormatReadable(Ft)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Gt.textureTypeReadable(Rt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}L>=0&&L<=x.width-B&&F>=0&&F<=x.height-D&&(x.textures.length>1&&T.readBuffer(T.COLOR_ATTACHMENT0+Mt),T.readPixels(L,F,B,D,at.convert(Ft),at.convert(Rt),nt))}finally{let Nt=U!==null?gt.get(U).__webglFramebuffer:null;ht.bindFramebuffer(T.FRAMEBUFFER,Nt)}}},this.readRenderTargetPixelsAsync=async function(x,L,F,B,D,nt,ft,Mt=0){if(!(x&&x.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let xt=gt.get(x).__webglFramebuffer;if(x.isWebGLCubeRenderTarget&&ft!==void 0&&(xt=xt[ft]),xt)if(L>=0&&L<=x.width-B&&F>=0&&F<=x.height-D){ht.bindFramebuffer(T.FRAMEBUFFER,xt);let Nt=x.textures[Mt],Ft=Nt.format,Rt=Nt.type;if(!Gt.textureFormatReadable(Ft))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Gt.textureTypeReadable(Rt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");let Xt=T.createBuffer();T.bindBuffer(T.PIXEL_PACK_BUFFER,Xt),T.bufferData(T.PIXEL_PACK_BUFFER,nt.byteLength,T.STREAM_READ),x.textures.length>1&&T.readBuffer(T.COLOR_ATTACHMENT0+Mt),T.readPixels(L,F,B,D,at.convert(Ft),at.convert(Rt),0);let ne=U!==null?gt.get(U).__webglFramebuffer:null;ht.bindFramebuffer(T.FRAMEBUFFER,ne);let oe=T.fenceSync(T.SYNC_GPU_COMMANDS_COMPLETE,0);return T.flush(),await Tl(T,oe,4),T.bindBuffer(T.PIXEL_PACK_BUFFER,Xt),T.getBufferSubData(T.PIXEL_PACK_BUFFER,0,nt),T.deleteBuffer(Xt),T.deleteSync(oe),nt}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(x,L=null,F=0){let B=Math.pow(2,-F),D=Math.floor(x.image.width*B),nt=Math.floor(x.image.height*B),ft=L!==null?L.x:0,Mt=L!==null?L.y:0;Pt.setTexture2D(x,0),T.copyTexSubImage2D(T.TEXTURE_2D,F,0,0,ft,Mt,D,nt),ht.unbindTexture()};let mc=T.createFramebuffer(),gc=T.createFramebuffer();this.copyTextureToTexture=function(x,L,F=null,B=null,D=0,nt=null){nt===null&&(D!==0?(Gn("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),nt=D,D=0):nt=0);let ft,Mt,xt,Nt,Ft,Rt,Xt,ne,oe,ce=x.isCompressedTexture?x.mipmaps[nt]:x.image;if(F!==null)ft=F.max.x-F.min.x,Mt=F.max.y-F.min.y,xt=F.isBox3?F.max.z-F.min.z:1,Nt=F.min.x,Ft=F.min.y,Rt=F.isBox3?F.min.z:0;else{let ze=Math.pow(2,-D);ft=Math.floor(ce.width*ze),Mt=Math.floor(ce.height*ze),x.isDataArrayTexture?xt=ce.depth:x.isData3DTexture?xt=Math.floor(ce.depth*ze):xt=1,Nt=0,Ft=0,Rt=0}B!==null?(Xt=B.x,ne=B.y,oe=B.z):(Xt=0,ne=0,oe=0);let Jt=at.convert(L.format),Lt=at.convert(L.type),me;L.isData3DTexture?(Pt.setTexture3D(L,0),me=T.TEXTURE_3D):L.isDataArrayTexture||L.isCompressedArrayTexture?(Pt.setTexture2DArray(L,0),me=T.TEXTURE_2D_ARRAY):(Pt.setTexture2D(L,0),me=T.TEXTURE_2D),T.pixelStorei(T.UNPACK_FLIP_Y_WEBGL,L.flipY),T.pixelStorei(T.UNPACK_PREMULTIPLY_ALPHA_WEBGL,L.premultiplyAlpha),T.pixelStorei(T.UNPACK_ALIGNMENT,L.unpackAlignment);let jt=T.getParameter(T.UNPACK_ROW_LENGTH),Ge=T.getParameter(T.UNPACK_IMAGE_HEIGHT),jn=T.getParameter(T.UNPACK_SKIP_PIXELS),Le=T.getParameter(T.UNPACK_SKIP_ROWS),Ii=T.getParameter(T.UNPACK_SKIP_IMAGES);T.pixelStorei(T.UNPACK_ROW_LENGTH,ce.width),T.pixelStorei(T.UNPACK_IMAGE_HEIGHT,ce.height),T.pixelStorei(T.UNPACK_SKIP_PIXELS,Nt),T.pixelStorei(T.UNPACK_SKIP_ROWS,Ft),T.pixelStorei(T.UNPACK_SKIP_IMAGES,Rt);let ae=x.isDataArrayTexture||x.isData3DTexture,Be=L.isDataArrayTexture||L.isData3DTexture;if(x.isDepthTexture){let ze=gt.get(x),Me=gt.get(L),Ee=gt.get(ze.__renderTarget),Yr=gt.get(Me.__renderTarget);ht.bindFramebuffer(T.READ_FRAMEBUFFER,Ee.__webglFramebuffer),ht.bindFramebuffer(T.DRAW_FRAMEBUFFER,Yr.__webglFramebuffer);for(let Dn=0;Dn<xt;Dn++)ae&&(T.framebufferTextureLayer(T.READ_FRAMEBUFFER,T.COLOR_ATTACHMENT0,gt.get(x).__webglTexture,D,Rt+Dn),T.framebufferTextureLayer(T.DRAW_FRAMEBUFFER,T.COLOR_ATTACHMENT0,gt.get(L).__webglTexture,nt,oe+Dn)),T.blitFramebuffer(Nt,Ft,ft,Mt,Xt,ne,ft,Mt,T.DEPTH_BUFFER_BIT,T.NEAREST);ht.bindFramebuffer(T.READ_FRAMEBUFFER,null),ht.bindFramebuffer(T.DRAW_FRAMEBUFFER,null)}else if(D!==0||x.isRenderTargetTexture||gt.has(x)){let ze=gt.get(x),Me=gt.get(L);ht.bindFramebuffer(T.READ_FRAMEBUFFER,mc),ht.bindFramebuffer(T.DRAW_FRAMEBUFFER,gc);for(let Ee=0;Ee<xt;Ee++)ae?T.framebufferTextureLayer(T.READ_FRAMEBUFFER,T.COLOR_ATTACHMENT0,ze.__webglTexture,D,Rt+Ee):T.framebufferTexture2D(T.READ_FRAMEBUFFER,T.COLOR_ATTACHMENT0,T.TEXTURE_2D,ze.__webglTexture,D),Be?T.framebufferTextureLayer(T.DRAW_FRAMEBUFFER,T.COLOR_ATTACHMENT0,Me.__webglTexture,nt,oe+Ee):T.framebufferTexture2D(T.DRAW_FRAMEBUFFER,T.COLOR_ATTACHMENT0,T.TEXTURE_2D,Me.__webglTexture,nt),D!==0?T.blitFramebuffer(Nt,Ft,ft,Mt,Xt,ne,ft,Mt,T.COLOR_BUFFER_BIT,T.NEAREST):Be?T.copyTexSubImage3D(me,nt,Xt,ne,oe+Ee,Nt,Ft,ft,Mt):T.copyTexSubImage2D(me,nt,Xt,ne,Nt,Ft,ft,Mt);ht.bindFramebuffer(T.READ_FRAMEBUFFER,null),ht.bindFramebuffer(T.DRAW_FRAMEBUFFER,null)}else Be?x.isDataTexture||x.isData3DTexture?T.texSubImage3D(me,nt,Xt,ne,oe,ft,Mt,xt,Jt,Lt,ce.data):L.isCompressedArrayTexture?T.compressedTexSubImage3D(me,nt,Xt,ne,oe,ft,Mt,xt,Jt,ce.data):T.texSubImage3D(me,nt,Xt,ne,oe,ft,Mt,xt,Jt,Lt,ce):x.isDataTexture?T.texSubImage2D(T.TEXTURE_2D,nt,Xt,ne,ft,Mt,Jt,Lt,ce.data):x.isCompressedTexture?T.compressedTexSubImage2D(T.TEXTURE_2D,nt,Xt,ne,ce.width,ce.height,Jt,ce.data):T.texSubImage2D(T.TEXTURE_2D,nt,Xt,ne,ft,Mt,Jt,Lt,ce);T.pixelStorei(T.UNPACK_ROW_LENGTH,jt),T.pixelStorei(T.UNPACK_IMAGE_HEIGHT,Ge),T.pixelStorei(T.UNPACK_SKIP_PIXELS,jn),T.pixelStorei(T.UNPACK_SKIP_ROWS,Le),T.pixelStorei(T.UNPACK_SKIP_IMAGES,Ii),nt===0&&L.generateMipmaps&&T.generateMipmap(me),ht.unbindTexture()},this.copyTextureToTexture3D=function(x,L,F=null,B=null,D=0){return Gn('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(x,L,F,B,D)},this.initRenderTarget=function(x){gt.get(x).__webglFramebuffer===void 0&&Pt.setupRenderTarget(x)},this.initTexture=function(x){x.isCubeTexture?Pt.setTextureCube(x,0):x.isData3DTexture?Pt.setTexture3D(x,0):x.isDataArrayTexture||x.isCompressedArrayTexture?Pt.setTexture2DArray(x,0):Pt.setTexture2D(x,0),ht.unbindTexture()},this.resetState=function(){C=0,A=0,U=null,ht.reset(),Bt.reset()},typeof __THREE_DEVTOOLS__!="undefined"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Ye}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;let e=this.getContext();e.drawingBufferColorSpace=Yt._getDrawingBufferColorSpace(t),e.unpackColorSpace=Yt._getUnpackColorSpace()}};var lo=`
  varying vec2 vUv;
  void main() {
    vUv = uv;
    gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
...
`,document.head.appendChild(s)}let i=window.lenis||null;function t(e){e>100?gsap.to(document.documentElement,{duration:0,"--gap-size":1,ease:"power2.out"}):gsap.to(document.documentElement,{duration:0,"--gap-size":0,ease:"power2.out"})}i?i.on("scroll",({scroll:e})=>{t(e)}):$(window).scroll(function(){t($(this).scrollTop())})}var rc=0;function sn(i){window.lenisInstance&&(i===!0?t():e());function t(){rc=window.scrollY,$("body").css({overflow:"hidden",position:"fixed",top:"0",width:"100%"}),window.lenisInstance.scrollTo(0,{immediate:!0,onComplete:()=>{window.lenisInstance.stop()}})}function e(){$("body").css({overflow:"",position:"",top:"",width:""}),window.lenisInstance.start(),window.lenisInstance.scrollTo(rc,{})}}function Ep(){$("[data-scroll-top]").on("click",function(){window.lenisInstance?window.lenisInstance.scrollTo(0):window.scrollTo(0,0)})}function Ap(){function i(){let t=new Date,e={timeZone:"Europe/Paris",hour:"2-digit",minute:"2-digit",hour12:!0},n=t.toLocaleTimeString("en-GB",e);$("[data-time-cet]").text(`CET ${n}`)}i(),setInterval(i,1e3)}function Cp(){let t=document.querySelectorAll("[data-css-marquee]"),e=[],n;function s(h){if(h.getAttribute("data-initialized")==="true")return;h.querySelectorAll("[data-css-marquee-list]").forEach(d=>{let p=d.cloneNode(!0);h.appendChild(p)}),h.querySelectorAll("[data-css-marquee-list]").forEach(d=>{d.style.animationDuration=d.offsetWidth/60+"s",d.style.animationPlayState="paused"}),h.setAttribute("data-initialized","true"),e.push(h)}function r(h){let u=h.querySelectorAll("[data-css-marquee-list]");for(let p=u.length-1;p>=u.length/2;p--)u[p].remove();h.querySelectorAll("[data-css-marquee-list]").forEach(p=>{p.style.animationDuration="",p.style.animationPlayState=""}),h.setAttribute("data-initialized","false");let d=e.indexOf(h);d>-1&&e.splice(d,1)}function a(h){let u=parseInt(h.getAttribute("data-breakpoint")||"0");window.innerWidth<=u?s(h):h.getAttribute("data-initialized")==="true"&&r(h)}let o=new IntersectionObserver(h=>{h.forEach(u=>{u.target.getAttribute("data-initialized")==="true"&&u.target.querySelectorAll("[data-css-marquee-list]").forEach(d=>d.style.animationPlayState=u.isIntersecting?"running":"paused")})},{threshold:0});function l(){t.forEach(h=>{a(h),o.observe(h)})}function c(){clearTimeout(n),n=setTimeout(()=>{t.forEach(h=>{a(h)})},250)}window.addEventListener("resize",c),l()}function ac(){function i(n,s=!1){let r=document.getElementById(n);if(r&&window.lenisInstance){let a=()=>{window.lenisInstance.scrollTo(r,{duration:1,easing:o=>Math.min(1,1.001-Math.pow(2,-10*o))})};s?a():setTimeout(a,100),s&&window.history.pushState({},"",window.location.pathname+"?anchor="+n)}}let e=new URLSearchParams(window.location.search).get("anchor");console.log(e),e&&i(e),$('a[href^="?anchor="], a[href^="#"], a[href*="'+window.location.pathname+'?anchor="]').on("click",function(n){let s=$(this).attr("href"),r;if(s.startsWith("#"))r=s.substring(1);else if(s.includes("?anchor=")){let a=s.split("?"),o=window.location.pathname,l=a[0]||o;(l===o||l==="")&&(n.preventDefault(),r=new URLSearchParams(a[1]).get("anchor"))}r&&i(r,!0)})}function Rp(){$("[data-copy-clipboard]").on("click",function(){let i=$(this).attr("data-copy-clipboard"),t=$(`[data-copy-clipboard="${i}"]`).find(".line");if(t.length){let e=t.text(),n=()=>{let s=$('<div class="copy-tooltip">Copied</div>');s.css({position:"absolute",background:"var(--body-2)",color:"var(--text-2)",padding:".5em 1em",borderRadius:".25em",fontSize:"1.5rem",whiteSpace:"nowrap",zIndex:9999,pointerEvents:"none"});let r=t.offset();s.css({top:r.top-40,left:r.left+t.outerWidth()/2-s.outerWidth()/2}),$("body").append(s),setTimeout(()=>{s.remove()},1500)};navigator.clipboard.writeText(e).then(()=>{n()}).catch(()=>{let s=document.createElement("textarea");s.value=e,document.body.appendChild(s),s.select(),document.execCommand("copy"),document.body.removeChild(s),n()})}})}function Ip(i){window.Webflow&&window.Webflow.destroy(),window.Webflow&&window.Webflow.ready(),window.Webflow&&window.Webflow.require&&window.Webflow.require("ix2")&&window.Webflow.require("ix2").init(),$(".w--current").removeClass("w--current"),$("a").each(function(){$(this).attr("href")===window.location.pathname&&$(this).addClass("w--current")})}var Pp={isOpen:!1,$overlay:null,$container:null,$videoWrapper:null,$originalElement:null,originalMaxWidth:null,originalPlayers:[],modalPlayer:null,init(){this.initOriginalPlyrs(),this.bindEvents(),this.addStyles()},initOriginalPlyrs(){let i=$(".plyr_video");i.length&&(this.originalPlayers=[],i.each((t,e)=>{let n=new Plyr(e,{controls:["play","progress","mute","fullscreen"],muted:!0,autoplay:!0,loop:{active:!0}});$(e).closest("[data-video-player]").find(".plyr__controls").hide(),n.on("ready",()=>{setTimeout(()=>{n.play(),n.muted=!0},100)}),n.on("loadeddata",()=>{n.play()}),this.originalPlayers.push(n)}))},bindEvents(){$("[data-video-player]").each((i,t)=>{$(t).click(e=>{e.preventDefault(),this.open($(e.currentTarget))})})},open(i){this.isOpen||(this.$originalElement=i,this.originalMaxWidth=i.css("max-width"),sn(!0),i.css("max-width","none"),this.createElement(),this.setupModal(i),this.animateIn(),this.isOpen=!0)},close(){this.isOpen&&(this.pauseVideo(),this.animateOut())},createElement(){this.$overlay=$('<div class="video-modal-overlay"></div>'),this.$container=$('<div class="video-modal-container"></div>'),this.$videoWrapper=$('<div class="video-modal-wrapper"></div>');let i=$('<div class="video-modal-close">\xD7</div>');this.$videoWrapper.append(i),this.$container.append(this.$videoWrapper),this.$overlay.append(this.$container),$("body").append(this.$overlay),this.bindCloseEvents(i)},setupModal(i){let t=i[0].getBoundingClientRect(),e=i.attr("data-video-player")||"16/9";this.$container.css({position:"fixed",left:t.left+"px",top:t.top+"px",width:t.width+"px",height:t.height+"px",zIndex:9999}),this.$videoWrapper.css("aspect-ratio",e);let n=i.clone(!0);n.find(".plyr").replaceWith(n.find("video")),this.$videoWrapper.append(n),i.css("visibility","hidden")},animateIn(){gsap.set(this.$overlay,{opacity:0}),gsap.to(this.$overlay,{opacity:1,duration:.3}),gsap.to(this.$container,{left:"5vw",top:"5vh",width:"90vw",height:"90vh",duration:.6,ease:"power2.out",onComplete:()=>this.activateModalVideo()})},activateModalVideo(){let t=this.$videoWrapper.find("[data-video-player]").find(".plyr_video");t.length&&(this.modalPlayer=new Plyr(t[0],{controls:["play","progress","mute","fullscreen"],muted:!1,autoplay:!1,loop:{active:!0}}),this.modalPlayer.on("ready",()=>{setTimeout(()=>{this.modalPlayer.restart(),this.modalPlayer.muted=!1,this.modalPlayer.play().catch(()=>{console.log("Autoplay prevented - user interaction required")})},100)}))},animateOut(){let i=this.$originalElement[0].getBoundingClientRect();gsap.to(this.$container,{left:i.left+"px",top:i.top+"px",width:i.width+"px",height:i.height+"px",duration:.4,ease:"power2.in"}),gsap.to(this.$overlay,{opacity:0,duration:.3,delay:.2,onComplete:()=>this.cleanup()})},cleanup(){this.$overlay.remove(),this.$originalElement.css({visibility:"visible","max-width":this.originalMaxWidth}),this.modalPlayer&&(this.modalPlayer.destroy(),this.modalPlayer=null),sn(!1),$(document).off("keydown.videoModal"),this.resetProperties()},resetProperties(){this.isOpen=!1,this.$overlay=null,this.$container=null,this.$videoWrapper=null,this.$originalElement=null,this.originalMaxWidth=null},bindCloseEvents(i){i.click(()=>this.close()),this.$overlay.click(t=>{t.target===this.$overlay[0]&&this.close()}),$(document).on("keydown.videoModal",t=>{t.key==="Escape"&&this.close()})},playVideo(){this.modalPlayer&&this.modalPlayer.play()},pauseVideo(){this.modalPlayer&&this.modalPlayer.pause()},addStyles(){$("<style>").text(`
    ...
    `).appendTo("head")}};function oc(){let i=document.querySelector(".cursor"),t=i.querySelector("p"),e=document.querySelectorAll("[data-cursor]"),n=6,s=140,r=!1,a=null,o="",l=!1,c,h,u=()=>window.innerWidth>=992,d=()=>{u()&&(l=!0,gsap.set(i,{xPercent:n,yPercent:s,scale:.8}),c=gsap.quickTo(i,"x",{ease:"power3"}),h=gsap.quickTo(i,"y",{ease:"power3"}),i.style.display="block")},p=()=>{l=!1,i&&(i.style.display="none")},g=()=>i.offsetWidth+16,v=E=>{if(!l)return;let w=window.innerWidth,M=window.innerHeight,{scrollY:P}=window,C=E.clientX,A=E.clientY+P,U=n,S=s,y=g();if(C>w-y?(r=!0,U=-100):r=!1,A>P+M*.9&&(S=-120),a){let I=a.getAttribute("data-cursor");I!==o&&(t.innerHTML=I,o=I,y=g())}gsap.to(i,{xPercent:U,yPercent:S,duration:.9,scale:1,ease:"power3"}),c(C),h(A-P)},m=E=>{if(!l)return;a=E;let w=E.getAttribute("data-cursor");w!==o&&(t.innerHTML=w,o=w,g()),E.tagName!=="A"?(i.style.backgroundColor="var(--text-3)",i.style.color="var(--body-2)"):(i.style.backgroundColor="",i.style.color="")},f=()=>{u()&&!l?d():!u()&&l&&p()};window.addEventListener("mousemove",v),window.addEventListener("resize",f),e.forEach(E=>{E.addEventListener("mouseenter",()=>m(E))}),u()&&d()}function Lp(){$(".footer-gif-trigger").on("mouseenter click",function(){$(".footer_gif").css("height","auto");let i=$(".footer_gif").height();$(".footer_gif").css("height","0"),$(".footer_gif").animate({height:i},300)})}function Dp(){let i=$('[data-nav-toggle="open"]'),t=$('[data-nav-toggle="close"]'),e=$(".nav_menu"),n=$("[data-menu-brand]"),s=$(".nav_menu-item"),r=$(".nav_menu-sublinks li"),a=$(".nav_menu-meta");gsap.set(e,{display:"none"}),gsap.set([e,s,r,a],{opacity:0}),gsap.set(n,{text:""});let o={open:()=>{let h=gsap.timeline();return Ri(n,n.attr("data-menu-text")),h.set(e,{display:"flex"}),h.set(t,{yPercent:100}),h.to(i.find("svg"),{scale:0,ease:"power4.out"}),h.to(i,{scale:0,ease:"power4.out"},"<0.1"),h.to(e,{opacity:1},"<"),h.to(t,{yPercent:0}),h.to(s,{opacity:1,stagger:.1},"<"),h.fromTo(s.find(".nav_menu-item_list"),{scale:0},{scale:1,stagger:.1},"<0.3"),h.fromTo(s.find("p"),{yPercent:300},{yPercent:0,stagger:.1,duration:.6},"<"),h.fromTo(s.find(".w-embed"),{xPercent:300},{xPercent:0,stagger:.1,duration:.6},"<"),h.to([r,a],{opacity:1,stagger:.2},"<"),h},close:()=>{let h=gsap.timeline();return h.to([r,a],{opacity:0,duration:.3}),h.to(t,{yPercent:100},"<"),h.to(s.find("p"),{yPercent:300,stagger:.05,duration:1},"<0.2"),h.to(s.find(".nav_menu-item_list"),{scale:0,stagger:.1},"<"),h.to(s,{opacity:0,stagger:.1},"<"),h.to(e,{opacity:0},"<0.4"),h.to(i.find("svg"),{scale:1,ease:"power4.out"},"<"),h.to(i,{scale:1,ease:"power4.out"},"<"),h.set(e,{display:"none"}),Ri(n,""),h}};function l(){o.open(),sn(!0)}function c(){o.close(),sn(!1)}i.on("click",l),t.on("click",c)}function Up(){$(".nav_meta-col").each(function(){let i=$(this).find("a"),t=$(this).find("p");as(i),as(t),gsap.fromTo($(".nav_mode"),{scale:0},{scale:1})})}function Np(){let i=$("[data-back-to-home]"),t=i.find("[data-back-label]"),e=t.attr("data-original-text");i.hover(function(){Ri(t,"Home, sweet home")},function(){Ri(t,e)})}function Fp(){$(".hp-hero_content-block").each(function(){let i=gsap.timeline();as($(this).find(".hp-hero_content-label").eq(0)),i.fromTo($(this).find("li"),{opacity:0,xPercent:-5},{opacity:1,xPercent:0,stagger:.2})}),$(".hp-hero_content-visual").each(function(){gsap.set($(this),{clipPath:"polygon(0% 0%, 0% 0%, 0% 100%, 0% 100%)"}),gsap.to($(this),{clipPath:"polygon(0% 0%, 100% 0%, 100% 100%, 0% 100%)",duration:1.5,ease:"power3.inOut",onComplete:()=>{$(this).css("clip-path","")}})})}function Op(){gsap.matchMedia().add("(min-width: 992px)",()=>{gsap.timeline({scrollTrigger:{trigger:$(".hp-hero"),start:"center top",end:"bottom top",scrub:1,onEnterBack:()=>{gsap.to($(".hp-work_head-link"),{rotate:0})},onLeave:()=>{gsap.to($(".hp-work_head-link"),{rotate:180})}}}).to($(".hp-hero").add(".nav_wrapper"),{opacity:.1})})}function lc(i,t){console.log($(i).find(t)),$(i).find(t).hover(function(){let e=$(this).parent().index(),n=$(".links-imgs_box-item").length,s=-(e*(100/n));gsap.to(".links-imgs_box-list",{yPercent:s,duration:.3,ease:"power2.inOut"})}),$(i).hover(function(){gsap.to(".links-imgs_box-wrap",{scale:1,duration:.2,ease:"power4.in"})},function(){gsap.to(".links-imgs_box-wrap",{scale:0,duration:.2,ease:"power4.out"})})}function Bp(){gsap.matchMedia().add("(min-width: 992px)",()=>{let t=$(".work_slider-item"),e=t.length,n=$(".work-wall"),s=$(".hp-work_slider-row"),r=e*100,a=r;n.css("height",a+"vh"),gsap.registerPlugin(ScrollTrigger),gsap.to(s,{xPercent:-(r-100),ease:"none",scrollTrigger:{trigger:n,start:"top top",end:"bottom bottom",scrub:1,pin:!1}});let o=$(".work_slider-item img");if(window.lenisInstance){let l=!1,c;window.lenisInstance.on("scroll",h=>{$(window).width()>991&&(Math.abs(h.velocity)>15&&!l&&(l=!0,gsap.to(o,{scale:1.1,duration:1,ease:"power4.out"}),gsap.to(t.find(".work_slider-item_visual"),{scale:.8,duration:1,ease:"power4.out"})),clearTimeout(c),c=setTimeout(()=>{l=!1,gsap.to(o,{scale:1,duration:1,ease:"power4.out"}),gsap.to(t.find(".work_slider-item_visual"),{scale:1,duration:1,ease:"power4.out"})},15))})}})}function zp(){$("[data-work-counter]").text("("+$(".work_slider-item").length+")")}function kp(){var i=gsap.timeline({});let t=".work-d_hero-wrap.cc-images",e=".work-d_hero-wrap.cc-images .work-d_hero-list",n=".work-d_hero-wrap.cc-images .work-d_hero-list-item",s=".work-d_hero-timeline-box",r=".work-navigation";i.set([s,r],{y:"10vh",rotate:.001,opacity:0},"<"),i.to(e,{duration:1,ease:"Power4.easeOut",rotate:.001,y:0,clearProps:"all",delay:0,onComplete:()=>{as($('[data-split="work-heading"]'))}},"<"),i.from(n,{duration:2,ease:"Expo.easeInOut",rotate:.001,opacity:0,y:"0px",clearProps:"all"},"<"),i.to([s,r],{duration:2.1,ease:"Expo.easeInOut",rotate:.001,y:0,opacity:1,clearProps:"all"},"<")}function Vp(){let i;function t(){i&&i.kill();let e=$(".work-d_hero-part.cc-images"),n=$(".work-d_hero-list"),s=$(".work-d_hero-list-item"),r=$(".work-d_hero-timeline"),a=$(".work-d_hero-timeline-inner"),o=s.first(),l=s.last(),c=$(".work-d_hero-timeline_item"),h=$(window).width()<992;gsap.set(a,{y:0,x:0});let u=gsap.timeline({paused:!0});h&&u.fromTo(c.find(".work-d_hero-timeline_mask"),{yPercent:50,opacity:0},{yPercent:0,opacity:1,stagger:.2}),i=ScrollTrigger.create({trigger:e[0],onEnter:()=>{r.addClass("cc-active"),h&&u.play()},onEnterBack:()=>{r.addClass("cc-active"),h&&u.play()},onLeave:()=>{r.removeClass("cc-active"),h&&u.reverse()},onLeaveBack:()=>{r.removeClass("cc-active"),h&&u.reverse()},start:()=>{let d=o.offset().top,p=o.outerHeight(),g=d-p/2;return"0px center"},end:()=>{let d=n.outerHeight(),p=l.outerHeight();return d-p/2+"px center"},scrub:0,onUpdate:d=>{let p=$(window).width()<992,g=$(window).height(),m=$(window).scrollTop()+g/2,f=o.offset().top,E=o.outerHeight(),w=f+E/2;if(m<w){gsap.set(a,{y:0,x:0}),c.removeClass("active"),c.eq(0).addClass("active");return}let M=0;s.each(function(C){let A=$(this),U=A.offset().top,S=A.outerHeight(),y=U+S/2;if(m<y)return!1;M+=1}),M=Math.max(0,M-1);let P=M;if(P<s.length-1){let C=s.eq(P),A=s.eq(P+1);if(C.length&&A.length){let U=C.offset().top+C.outerHeight()/2,S=A.offset().top+A.outerHeight()/2;if(m>U){let y=(m-U)/(S-U);M+=Math.min(1,Math.max(0,y))}}}if(p){let C=c.first().outerWidth(!0),A=M*C;gsap.set(a,{x:-A,y:0})}else{let C=c.first().outerHeight(!0),A=M*C;gsap.set(a,{y:-A,x:0})}}}),$(document).off("click.workTimeline",".work-d_hero-timeline_item"),$(document).on("click.workTimeline",".work-d_hero-timeline_item",function(){let d=$(this).index(),p=s.eq(d);if(p.length){let g=p.offset().top,v=p.outerHeight(),m=$(window).height(),f=g+v/2-m/2;typeof lenisInstance!="undefined"&&lenisInstance.scrollTo?lenisInstance.scrollTo(f,{duration:1.2,easing:E=>Math.min(1,1.001-Math.pow(2,-10*E))}):$("html, body").animate({scrollTop:Math.max(0,f)},1200)}})}t(),$(window).off("resize.workTimeline"),$(window).on("resize.workTimeline",function(){setTimeout(t,100)})}function Hp(){let i=$(".work-d_content-part_icon"),t=gsap.timeline({scrollTrigger:{trigger:i}});t.from(i,{scale:0}),t.from(i.find("svg"),{scale:0,delay:.2},"<")}function Gp(){$(document).ready(function(){let i=$(".about_visual-box-inner-extra img"),t=i.length,e=-1,n=[];if(t===0)return;function s(){n=Array.from({length:t},(o,l)=>l);for(let o=n.length-1;o>0;o--){let l=Math.floor(Math.random()*(o+1));[n[o],n[l]]=[n[l],n[o]]}}s(),i.css({display:"block",opacity:0}),$(".about_visual-box-inner").on("click",function(){if(e>=t-1){a();return}r()});function r(){e++;let o=Math.random()*10-5,c=Math.pow(.7,e+1)*.99,h=n[e],u=i.eq(h);gsap.set(u[0],{opacity:0,scale:.8,rotation:o+2,zIndex:e+10}),gsap.to(u[0],{opacity:1,scale:.7,rotation:o,duration:.6,ease:"back.out(1.2)",delay:.1})}function a(){gsap.to(i,{opacity:0,scale:.8,duration:.4,stagger:.05,ease:"power2.in",onComplete:function(){gsap.set(i,{scale:1,rotation:0,zIndex:"auto"}),e=-1,s()}})}})}function Wp(){function i(s){let r=s.activeIndex,a=s.slides[r];Ri($('[data-work-slider="title"]'),$(a).attr("data-title")),Ri($('[data-work-slider="desc"]'),$(a).attr("data-description"))}let t=new Swiper(".why-hero_cases-slider",{slidesPerView:1,effect:"fade",fadeEffect:{crossfade:!0},loop:!0,pagination:{el:".swiper-nav.cc-cases",bulletClass:"swiper-dot",bulletActiveClass:"cc-active",clickable:!0},on:{slideChange:function(){i(this)},init:function(){i(this)}}}),e=new Swiper(".why-hero_quotes-slider",{slidesPerView:1,effect:"fade",fadeEffect:{crossFade:!0},loop:!0,speed:200,navigation:{nextEl:".why-hero_quotes-slide-inner"},pagination:{el:".swiper-nav.cc-quotes",bulletClass:"swiper-dot",bulletActiveClass:"cc-active",clickable:!0},on:{init:function(){n(this),$(".swiper-slide").each(function(){gsap.set($(this).find("[data-item-el]"),{yPercent:50,opacity:0})}),gsap.to($(".swiper-slide-active [data-item-el]"),{yPercent:0,opacity:1,stagger:.2,duration:.6,ease:"power2.out"})},slideChangeTransitionEnd:function(){gsap.to($(".swiper-slide:not(.swiper-slide-active) [data-item-el]"),{yPercent:50,opacity:0,stagger:.1,duration:.3}),gsap.to($(".swiper-slide-active [data-item-el]"),{yPercent:0,opacity:1,stagger:.2,duration:.6,delay:.2,ease:"power2.out"})}}});function n(s){let{slides:r}=s,a=r.length;r.forEach((o,l)=>{let c=$(o).find(".why-hero_quotes-avatar-circle.cc-1"),h=$(o).find(".why-hero_quotes-avatar-circle.cc-2"),u=(l+1)%a,d=(l+2)%a,p=$(r[u]).find(".why-hero_quotes-avatar-circle.cc-avatar img").attr("src"),g=$(r[d]).find(".why-hero_quotes-avatar-circle.cc-avatar img").attr("src");g&&c.find("img").attr("src",g),p&&h.find("img").attr("src",p)})}}function Xp(){document.querySelectorAll("[data-form-validate]").forEach(t=>{let e=new Date().getTime(),n=t.querySelector("form");if(!n)return;let s=n.querySelectorAll("[data-validate]"),r=n.querySelector("[data-submit]");if(!r)return;let a=r.querySelector('input[type="submit"]');if(!a)return;function o(){return new Date().getTime()-e<5e3}s.forEach(function(u){let d=u.querySelector("select");d&&d.querySelectorAll("option").forEach(function(g){(g.value===""||g.value==="disabled"||g.value==="null"||g.value==="false")&&g.setAttribute("disabled","disabled")})});function l(){let u=!0,d=null;return s.forEach(function(p){let g=p.querySelector("input, textarea, select"),v=p.querySelector("[data-radiocheck-group]");!g&&!v||(g&&(g.__validationStarted=!0),v&&(v.__validationStarted=!0,v.querySelectorAll('input[type="radio"], input[type="checkbox"]').forEach(function(f){f.__validationStarted=!0})),h(p),c(p)||(u=!1,d||(d=g||v.querySelector("input"))))}),!u&&d&&d.focus(),u}function c(u){let d=u.querySelector("[data-radiocheck-group]");if(d){let w=d.querySelectorAll('input[type="radio"], input[type="checkbox"]'),M=d.querySelectorAll("input:checked"),P=parseInt(d.getAttribute("min"))||1,C=parseInt(d.getAttribute("max"))||w.length,A=M.length;return w[0].type==="radio"?A>=1:w.length===1?w[0].checked:A>=P&&A<=C}let p=u.querySelector("input, textarea, select");if(!p)return!1;let g=!0,v=parseInt(p.getAttribute("min"))||0,m=parseInt(p.getAttribute("max"))||1/0,f=p.value.trim(),{length:E}=f;return p.tagName.toLowerCase()==="select"?(f===""||f==="disabled"||f==="null"||f==="false")&&(g=!1):p.type==="email"?g=/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(f):(p.hasAttribute("min")&&E<v&&(g=!1),p.hasAttribute("max")&&E>m&&(g=!1)),g}function h(u){let d=u.querySelector("[data-radiocheck-group]");if(d){let p=d.querySelectorAll('input[type="radio"], input[type="checkbox"]');d.querySelectorAll("input:checked").length>0?u.classList.add("is--filled"):u.classList.remove("is--filled"),c(u)?(u.classList.add("is--success"),u.classList.remove("is--error")):(u.classList.remove("is--success"),Array.from(p).some(f=>f.__validationStarted)?u.classList.add("is--error"):u.classList.remove("is--error"))}else{let p=u.querySelector("input, textarea, select");if(!p)return;p.value.trim()?u.classList.add("is--filled"):u.classList.remove("is--filled"),c(u)?(u.classList.add("is--success"),u.classList.remove("is--error")):(u.classList.remove("is--success"),p.__validationStarted?u.classList.add("is--error"):u.classList.remove("is--error"))}}s.forEach(function(u){let d=u.querySelector("input, textarea, select"),p=u.querySelector("[data-radiocheck-group]");p?p.querySelectorAll('input[type="radio"], input[type="checkbox"]').forEach(function(v){v.__validationStarted=!1,v.addEventListener("change",function(){requestAnimationFrame(function(){if(!v.__validationStarted){let m=p.querySelectorAll("input:checked").length,f=parseInt(p.getAttribute("min"))||1;m>=f&&(v.__validationStarted=!0)}v.__validationStarted&&h(u)})}),v.addEventListener("blur",function(){v.__validationStarted=!0,h(u)})}):d&&(d.__validationStarted=!1,d.tagName.toLowerCase()==="select"?d.addEventListener("change",function(){d.__validationStarted=!0,h(u)}):(d.addEventListener("input",function(){let g=d.value.trim(),{length:v}=g,m=parseInt(d.getAttribute("min"))||0,f=parseInt(d.getAttribute("max"))||1/0;d.__validationStarted||(d.type==="email"?c(u)&&(d.__validationStarted=!0):(d.hasAttribute("min")&&v>=m||d.hasAttribute("max")&&v<=f)&&(d.__validationStarted=!0)),d.__validationStarted&&h(u)}),d.addEventListener("blur",function(){d.__validationStarted=!0,h(u)})))}),r.addEventListener("click",function(){if(l()){if(o()){alert("Form submitted too quickly. Please try again.");return}a.click()}}),n.addEventListener("keydown",function(u){if(u.key==="Enter"&&u.target.tagName!=="TEXTAREA"&&(u.preventDefault(),l())){if(o()){alert("Form submitted too quickly. Please try again.");return}a.click()}})}),$(".form-checkbox").each(function(){let t=$(this),e=t.find('input[type="checkbox"], input[type="radio"]');function n(){e.attr("type")==="radio"&&$(`input[name="${e.attr("name")}"]`).not(":checked").each(function(){$(this).closest(".form-checkbox").removeClass("cc-active")}),e.is(":checked")?t.addClass("cc-active"):t.removeClass("cc-active")}n(),e.on("change",n)})}function qp(){console.log("Shaders available:",{vertex:typeof lo,fragment:typeof co});let i={cellSize:.75,zoomLevel:1.25,lerpFactor:.075,borderColor:"rgba(255, 255, 255, 0.15)",backgroundColor:"transparent",textColor:"#ffffff",hoverColor:"rgba(255, 255, 255, 0)"},t=[];$("[data-lab-item]").each(function(){let k=$(this),G={id:k.attr("data-lab-item"),title:k.find("[data-lab-title]").text().trim(),desc:k.find("[data-lab-desc]").text().trim(),image:k.find("[data-lab-img]").attr("src")};t.push(G)});let e,n,s,r,a=!1,o=!0,l=0,c={x:0,y:0},h={x:0,y:0},u={x:0,y:0},d={x:-1,y:-1},p=1,g=1,v=[],m={x:-999,y:-999},f={x:-999,y:-999},E=0,w=0,M=.15,P=k=>{if(k==="transparent")return[0,0,0,0];if(k.startsWith("#")){let rt=k.slice(1),pt=parseInt(rt.substr(0,2),16)/255,It=parseInt(rt.substr(2,2),16)/255,T=parseInt(rt.substr(4,2),16)/255;return[pt,It,T,1]}let G=k.match(/rgba?\(([^)]+)\)/);return G?G[1].split(",").map((rt,pt)=>pt<3?parseFloat(rt.trim())/255:parseFloat(rt.trim()||1)):[0,0,0,1]},C=()=>{let k=document.getElementById("gallery");return getComputedStyle(k).color||"#ffffff"},A=(k,G)=>{let rt=document.createElement("canvas");rt.width=2048,rt.height=512;let pt=rt.getContext("2d");pt.clearRect(0,0,2048,512),pt.font="60px Arial",pt.fillStyle=C(),pt.textBaseline="top";let T=((Tt,Gt)=>{let ht=Tt.split(" "),Ot=[],gt=ht[0];for(let Pt=1;Pt<ht.length;Pt++){let Qt=ht[Pt],{width:b}=pt.measureText(gt+" "+Qt);b<Gt?gt+=" "+Qt:(Ot.push(gt),gt=Qt)}return Ot.push(gt),Ot})(k,1800);T.forEach((Tt,Gt)=>{pt.fillText(Tt,50,50+Gt*70)}),pt.fillStyle="#999999",pt.fillText(G,50,50+T.length*70+20);let Ht=new xi(rt);return Object.assign(Ht,{wrapS:be,wrapT:be,minFilter:we,magFilter:we,flipY:!1,generateMipmaps:!1,format:Pe}),Ht},U=(k,G=!1)=>{let pt=k.length,It=1,T=512,Ht=document.createElement("canvas");Ht.width=pt*T,Ht.height=It*T;let Tt=Ht.getContext("2d");G?Tt.clearRect(0,0,Ht.width,Ht.height):(Tt.fillStyle="black",Tt.fillRect(0,0,Ht.width,Ht.height)),k.forEach((ht,Ot)=>{var Qt,b;let gt=Ot%pt*T,Pt=Math.floor(Ot/pt)*T;G&&((Qt=ht.source)!=null&&Qt.data)?Tt.drawImage(ht.source.data,gt,Pt,T,T):G||((b=ht.image)!=null&&b.complete&&ht.image.naturalWidth>0?Tt.drawImage(ht.image,gt,Pt,T,T):(Tt.fillStyle="#ff0000",Tt.fillRect(gt,Pt,T,T)))});let Gt=new xi(Ht);return Object.assign(Gt,{wrapS:be,wrapT:be,minFilter:ve,magFilter:ve,flipY:!1}),Gt.needsUpdate=!0,{texture:Gt,atlasWidth:pt,atlasHeight:It}},S=()=>{let k=new Ji,G=[],rt=0;return new Promise(pt=>{t.forEach((It,T)=>{let Ht=k.load(It.image,()=>{++rt===t.length&&pt(G)},void 0,Tt=>{++rt===t.length&&pt(G)});Object.assign(Ht,{wrapS:be,wrapT:be,minFilter:ve,magFilter:ve}),G.push(Ht),v.push(A(It.title,It.year))})})},y=(k,G)=>{let rt=Math.floor((k+G*3)%t.length),pt=rt<0?t.length+rt:rt;return t[pt]},I=()=>{if(!s||d.x<0||d.y<0){f={x:-999,y:-999};return}let k=s.domElement.getBoundingClientRect(),G=d.x/k.width*2-1,rt=-(d.y/k.height*2-1),pt=Math.sqrt(G*G+rt*rt),It=1-.08*pt*pt,T=G*It,Ht=rt*It,Tt=k.width/k.height,Gt=T*Tt*p+h.x,ht=Ht*p+h.y,Ot=Gt/i.cellSize*.95,gt=ht/i.cellSize*.95,Pt=Math.floor(Ot),Qt=Math.floor(gt);f={x:Pt,y:Qt}},Z=k=>{let G=s.domElement.getBoundingClientRect();d.x=k.clientX-G.left,d.y=k.clientY-G.top,I(),r!=null&&r.material.uniforms&&r.material.uniforms.uMousePos.value.set(d.x,d.y)},z=(k,G,rt)=>k+(G-k)*rt,X=k=>{let{target:G}=k;return G.closest("nav")||G.closest(".navbar")||G.closest("[data-nav]")||G.closest("header")||G.tagName==="A"||G.closest("a")},j=(k,G,rt)=>X(k)?!1:(a=!0,o=!0,l=Date.now(),document.body.classList.add("dragging"),c.x=G,c.y=rt,setTimeout(()=>a&&(g=i.zoomLevel),150),!0),W=k=>{j(k,k.clientX,k.clientY)},it=k=>{j(k,k.touches[0].clientX,k.touches[0].clientY)&&k.preventDefault()},V=(k,G)=>{if(!a||k===void 0||G===void 0)return;let rt=k-c.x,pt=G-c.y;(Math.abs(rt)>2||Math.abs(pt)>2)&&(o=!1,g===1&&(g=i.zoomLevel)),u.x-=rt*.003,u.y+=pt*.003,c.x=k,c.y=G},ct=k=>V(k.clientX,k.clientY),mt=k=>{k.preventDefault(),V(k.touches[0].clientX,k.touches[0].clientY)},bt=k=>{var G,rt,pt,It;if(a&&(a=!1,document.body.classList.remove("dragging"),g=1,o&&Date.now()-l<200)){let T=k.clientX||((rt=(G=k.changedTouches)==null?void 0:G[0])==null?void 0:rt.clientX),Ht=k.clientY||((It=(pt=k.changedTouches)==null?void 0:pt[0])==null?void 0:It.clientY);if(T!==void 0&&Ht!==void 0&&!X(k)){let Tt=s.domElement.getBoundingClientRect(),Gt=(T-Tt.left)/Tt.width*2-1,ht=-((Ht-Tt.top)/Tt.height*2-1),Ot=Math.sqrt(Gt*Gt+ht*ht),gt=1-.08*Ot*Ot,Pt=Gt*gt*(Tt.width/Tt.height)*p+h.x,Qt=ht*gt*p+h.y,b=Math.floor(Pt/i.cellSize*.88),_=Math.floor(Qt/i.cellSize*.95),N=y(b,_);N&&(console.log("Clicked project:",N.id),Vt.open(N.id))}}},Vt={activePlayer:null,init(){this.setupEventListeners()},setupEventListeners(){$("[data-modal-close]").on("click",()=>this.close()),$(document).on("keydown",k=>{k.key==="Escape"&&this.close()}),$(".labs-modal_wrap").on("click",k=>{let G=$(k.target),rt=$(".labs-modal_video:visible"),pt=$(".labs-modal_img-item:visible");!G.closest(".labs-modal_video").length&&!G.closest(".labs-modal_img-item").length&&this.close()})},open(k){this.destroyVideo(),sn(!0),$(".labs-modal_wrap").css("display","flex"),$("[data-lab-item]").hide();let G=$(`[data-lab-item="${k}"]`);G.show(),this.handleMediaType(G)},close(){this.destroyVideo(),sn(!1),$("[data-lab-item]").hide(),$(".labs-modal_wrap").css("display","none")},handleMediaType(k){let G=k.find(".labs-modal_video"),rt=k.find(".labs-modal_img-item"),pt=G.find("video");if(G.hide(),rt.hide(),pt.length){let T=pt.find("source").attr("src")||pt.attr("src");T&&T.trim()!==""?(G.show(),this.initializeVideo(pt)):rt.css("display","flex")}else rt.css("display","flex")},initializeVideo(k){if(typeof Plyr!="undefined"){let G=k[0];G.currentTime=0,G.pause(),this.activePlayer=new Plyr(G,{controls:["play-large","play","progress","current-time","mute","volume","fullscreen"],autoplay:!1,loop:{active:!0}}),this.activePlayer.on("ready",()=>{this.activePlayer.currentTime=0,setTimeout(()=>{this.activePlayer&&$(".labs-modal_wrap").is(":visible")&&this.activePlayer.play()},100)}),this.activePlayer.on("loadeddata",()=>{this.activePlayer.currentTime=0})}},destroyVideo(){if(this.activePlayer){try{this.activePlayer.pause(),this.activePlayer.currentTime=0,this.activePlayer.destroy()}catch(k){console.log("Error destroying player:",k)}this.activePlayer=null}$("video").each(function(){this.pause(),this.currentTime=0,this.load()})}},te=()=>{let k=document.getElementById("gallery");if(!k)return;let{offsetWidth:G,offsetHeight:rt}=k;n.updateProjectionMatrix(),s.setSize(G,rt),s.setPixelRatio(window.devicePixelRatio),r==null||r.material.uniforms.uResolution.value.set(G,rt)},q=()=>{let k=new MutationObserver(G=>{G.forEach(rt=>{rt.type==="attributes"&&(rt.attributeName==="data-theme"||rt.attributeName==="class")&&setTimeout(()=>{st()},400)})});k.observe(document.documentElement,{attributes:!0,attributeFilter:["data-theme","class"]}),k.observe(document.body,{attributes:!0,attributeFilter:["data-theme","class"]})},st=()=>{var It,T;if(!((T=(It=r==null?void 0:r.material)==null?void 0:It.uniforms)!=null&&T.uTextAtlas))return;let k=t.map(Ht=>A(Ht.title,Ht.year)),G=U(k,!0),rt=r.material.uniforms.uTextAtlas.value;rt&&rt.dispose&&rt.dispose();let pt=G.texture;pt.needsUpdate=!0,pt.colorSpace=Se,r.material.uniforms.uTextAtlas.value=pt,r.material.needsUpdate=!0,s.resetState(),s.compile(e,n),s.render(e,n)},wt=()=>{let k=document.getElementById("gallery");k.addEventListener("mousedown",W),k.addEventListener("mousemove",ct),k.addEventListener("mouseup",bt),k.addEventListener("mouseleave",bt);let G={passive:!1};k.addEventListener("touchstart",it,G),k.addEventListener("touchmove",mt,G),k.addEventListener("touchend",bt,G),window.addEventListener("resize",te),k.addEventListener("contextmenu",rt=>rt.preventDefault()),s.domElement.addEventListener("mousemove",Z),s.domElement.addEventListener("mouseleave",()=>{d.x=d.y=-1,f={x:-999,y:-999},w=0,r!=null&&r.material.uniforms&&r.material.uniforms.uMousePos.value.set(-1,-1)})},ut=()=>{requestAnimationFrame(ut),h.x+=(u.x-h.x)*i.lerpFactor,h.y+=(u.y-h.y)*i.lerpFactor,p+=(g-p)*i.lerpFactor,m.x!==f.x||m.y!==f.y?E>.01?E=z(E,0,M*1.5):(m.x=f.x,m.y=f.y,f.x!==-999&&(w=1)):(w=f.x===-999?0:1,E=z(E,w,M)),r!=null&&r.material.uniforms&&(r.material.uniforms.uOffset.value.set(h.x,h.y),r.material.uniforms.uZoom.value=p,r.material.uniforms.uHoveredCell.value.set(m.x,m.y),r.material.uniforms.uHoverIntensity.value=E),s.render(e,n)};(async()=>{let k=document.getElementById("gallery");if(!k)return;let G=k.querySelector("canvas");if(G&&G.remove(),t.length===0)return;e=new qi,n=new yi(-1,1,1,-1,.1,10),n.position.z=1,s=new Xr({antialias:!0,alpha:!0}),s.setSize(k.offsetWidth,k.offsetHeight),s.setPixelRatio(window.devicePixelRatio),s.setClearColor(new Zt(0,0,0),0),k.appendChild(s.domElement);let rt=await S(),pt=U(rt,!1),It=U(v,!0),T={uOffset:{value:new $t(0,0)},uResolution:{value:new $t(k.offsetWidth,k.offsetHeight)},uBorderColor:{value:new se(...P(i.borderColor))},uHoverColor:{value:new se(...P(i.hoverColor))},uBackgroundColor:{value:new se(...P(i.backgroundColor))},uMousePos:{value:new $t(-1,-1)},uZoom:{value:1},uCellSize:{value:i.cellSize},uTextureCount:{value:t.length},uAtlasSize:{value:pt.atlasSize},uAtlasWidth:{value:pt.atlasWidth},uAtlasHeight:{value:pt.atlasHeight},uImageAtlas:{value:pt.texture},uTextAtlas:{value:It.texture},uHoveredCell:{value:new $t(-999,-999)},uHoverIntensity:{value:0}},Ht=new mn(2,2),Tt=new Fe({vertexShader:lo,fragmentShader:co,uniforms:T});Tt.needsUpdate=!0,s.compile(e,n),r=new Ie(Ht,Tt),e.add(r),wt(),q(),ut(),Vt.init()})()}function Ri(i,t){let e="0123456789!@#$%^&*()_+<>?:|";gsap.to(i,{duration:.5,scrambleText:{text:t,chars:e,speed:.3,ease:"power2.inOut"}})}function as(i){let t={lines:{duration:.8,stagger:.08},words:{duration:.6,stagger:.06},chars:{duration:.4,stagger:.01}},e=[],n=[];function s(){n.forEach(o=>{o&&o.kill()}),e.forEach(o=>{o&&o.revert()}),e=[],n=[],$(i).each(function(){let o=$(this);if(o.hasClass("animated"))return;let l=o.data("split-reveal")||"lines",c=l==="lines"?["lines"]:l==="words"?["lines","words"]:["lines","words","chars"],h=o.closest("li").length>0;gsap.set(o,{visibility:"visible",opacity:1}),h&&gsap.set(o.closest("li"),{opacity:0});try{let u=new SplitText(o[0],{type:c.join(", "),mask:"lines",linesClass:"line",wordsClass:"word",charsClass:"letter"});e.push(u);let d=u[l];if(!d||d.length===0){console.warn("No split targets found for",o);return}gsap.set(d,{yPercent:110});let p=t[l],g=o.data("trigger-type")||"load",v=()=>{let m=gsap.timeline({onComplete:()=>{o.addClass("animated")}});return h&&m.to(o.closest("li"),{opacity:1,duration:p.duration*.3,ease:"power2.out"},0),m.to(d,{yPercent:-8,duration:p.duration,stagger:p.stagger,ease:"expo.out"},h?p.duration*.15:0),m};if(g==="scroll"){let m=ScrollTrigger.create({trigger:o[0],start:"clamp(top 80%)",once:!0,onEnter:v});n.push(m)}else gsap.delayedCall(.2,v)}catch(u){console.error("Error in SplitText:",u)}})}setTimeout(s,300);function r(o,l){let c;return function(){let h=this,u=arguments;clearTimeout(c),c=setTimeout(()=>o.apply(h,u),l)}}let a=r(s,200);return $(window).on("resize",a),function(){$(window).off("resize",a),n.forEach(l=>{l&&l.kill()}),e.forEach(l=>{l&&l.revert()})}}function $p(i){let t=[];function e(){t.forEach(r=>{r&&r.kill()}),t=[],$(i).each(function(){let r=$(this);if(r.hasClass("animated"))return;let a=r.data("duration")||.6,o=r.data("delay")||0,l=r.data("trigger-type")||"scroll";gsap.set(r,{opacity:0});let c=()=>{gsap.to(r,{opacity:1,duration:a,delay:o,ease:"power2.out",onComplete:()=>{r.addClass("animated")}})};if(l==="scroll"){let h=ScrollTrigger.create({trigger:r[0],start:"clamp(top 95%)",once:!0,onEnter:c});t.push(h)}else gsap.delayedCall(.2,c)})}setTimeout(e,300);function n(r,a){let o;return function(){let l=this,c=arguments;clearTimeout(o),o=setTimeout(()=>r.apply(l,c),a)}}let s=n(e,200);return $(window).on("resize",s),function(){$(window).off("resize",s),t.forEach(a=>{a&&a.kill()})}}function cc(){gsap.fromTo(".grid-line.is-h",{scaleX:0},{scaleX:1,stagger:.1,duration:6,immediateRender:!0,ease:"power4.out"}),gsap.fromTo(".grid-line.is-v",{scaleY:0},{scaleY:1,stagger:.1,duration:2,immediateRender:!0,ease:"power4.inOut"})}function Yp(){document.querySelectorAll("[data-button-animate-chars]").forEach(e=>{let n=e.textContent;e.innerHTML="",[...n].forEach((s,r)=>{let a=document.createElement("span");a.textContent=s,a.style.transitionDelay=`${r*.01}s`,s===" "&&(a.style.whiteSpace="pre"),e.appendChild(a)})})}function Zp(){Dp(),Tp(),wp(),Ep(),Ap(),cc(),Up(),Cp(),Np(),Rp(),ac(),document.fonts.ready.then(function(){as('[data-split="heading"]'),$p("[data-item-reveal]"),Yp()}),window.initDarkModeToggle(),Pp.init(),Lp()}function Jp(){Op(),Bp(),Fp(),lc(".hp-hero_content-clients ul",".hp-hero_links"),oc(),zp()}function Kp(){Vp(),kp(),Hp()}function Qp(){setTimeout(()=>{Gp(),cc(),lc(".about_clients-list.cc-clients",".about_clients-item"),oc()},500)}function jp(){Wp()}function tm(){Xp()}function hc(){window.addEventListener("pageshow",function(i){i.persisted&&(console.log("Page restored from bfcache - reloading"),window.location.reload())}),qp()}$(document).ready(function(){let i=$('[data-barba="container"]').data("barba-namespace");ho(),em()});function ho(i){var e,n,s;Zp();let t=((s=(n=(e=i==null?void 0:i.next)==null?void 0:e.container)==null?void 0:n.dataset)==null?void 0:s.barbaNamespace)||$('[data-barba="container"]').data("barba-namespace");t==="home"?Jp():t==="work"?Kp():t==="about"?Qp():t==="why"?jp():t==="contact"?tm():t==="labs"&&hc(),setTimeout(()=>{gsap.to("[data-barba=container]",{opacity:1})},300)}function em(){n();let i=null,t=null;barba.init({timeout:15e3,prefetchIgnore:!0,sync:!0,debug:!0,transitions:[s(),e()]});function e(){function r(a){let o=$("html"),l=$(a.current.container).find(".page-transition"),c=$(a.next.container).find(".page-transition"),h=gsap.timeline({defaults:{duration:.6,ease:"power2.inOut"}});return h.to(l,{scaleY:1,duration:.4,onComplete:()=>{sn(!0)}}),h.to(a.current.container,{scale:.8,duration:.5,onStart:()=>{gsap.set([a.current.container,a.next.container],{position:"fixed",top:0,left:0,width:"100%",height:"100vh",overflow:"hidden"}),gsap.set(o,{backgroundColor:"#4C4C4C"}),gsap.set(a.next.container,{scale:.8,zIndex:2}),gsap.set(a.current.container,{zIndex:1})}},"-=0.1"),h.set(a.current.container,{opacity:0,pointerEvents:"none"},"+=0.2"),h.fromTo(c,{scaleY:1},{scaleY:0,duration:1,onStart:()=>{ho(a)}},"-=0.3"),h.set(a.next.container,{opacity:1},"<"),h.to(a.next.container,{scale:1,duration:1,onComplete:()=>{gsap.set(o,{backgroundColor:""}),gsap.set(a.next.container,{clearProps:"all"}),gsap.set(a.next.container,{opacity:1})}},"<"),h}return{name:"default-transition",before(a){document.documentElement.classList.add("is-animating")},async enter(a){await r(a),Ip(a)},async after(a){console.log("after"),sn(!1),document.documentElement.classList.remove("is-animating"),ac(),a.next.namespace==="labs"&&hc()}}}function n(){let r=document.createElement("style");r.innerHTML=`
  .barba-container {
    position: relative;
  }
