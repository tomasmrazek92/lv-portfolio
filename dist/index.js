...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:gn,depthTest:!1,depthWrite:!1})}function Ul(){return new Fe({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:oo(),fragmentShader:`
		...
		`,blending:gn,depthTest:!1,depthWrite:!1})}function Nl(){return new Fe({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:oo(),fragmentShader:`
...
`)}function zf(i,t){let e;switch(t){case sl:e="Linear";break;case rl:e="Reinhard";break;case al:e="Cineon";break;case ol:e="ACESFilmic";break;case cl:e="AgX";break;case hl:e="Neutral";break;case ll:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}var Gr=new O;function kf(){Zt.getLuminanceCoefficients(Gr);let i=Gr.x.toFixed(4),t=Gr.y.toFixed(4),e=Gr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),t}function Zf(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Ea?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===Oo?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===je&&(t="SHADOWMAP_TYPE_VSM"),t}function Jf(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case qn:case $n:t="ENVMAP_TYPE_CUBE";break;case Ki:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Kf(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case $n:t="ENVMAP_MODE_REFRACTION";break}return t}function Qf(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Ia:t="ENVMAP_BLENDING_MULTIPLY";break;case nl:t="ENVMAP_BLENDING_MIX";break;case il:t="ENVMAP_BLENDING_ADD";break}return t}function jf(i){let t=i.envMapCubeUVHeight;if(t===null)return null;let e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function tp(i,t,e,n){let s=i.getContext(),r=e.defines,a=e.vertexShader,o=e.fragmentShader,l=Zf(e),c=Jf(e),h=Kf(e),u=Qf(e),d=jf(e),p=Vf(e),g=Hf(r),v=s.createProgram(),m,f,E=e.glslVersion?"#version "+e.glslVersion+`
...
`].filter(rs).join(`
`)),a=no(a),a=ql(a,e),a=$l(a,e),o=no(o),o=ql(o,e),o=$l(o,e),a=Yl(a),o=Yl(o),e.isRawShaderMaterial!==!0&&(E=`#version 300 es
...
`)+`
`+f);let T=E+m+a,M=E+f+o,P=Gl(s,s.VERTEX_SHADER,T),C=Gl(s,s.FRAGMENT_SHADER,M);s.attachShader(v,P),s.attachShader(v,C),e.index0AttributeName!==void 0?s.bindAttribLocation(v,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(v,0,"position"),s.linkProgram(v);function A(I){if(i.debug.checkShaderErrors){let Z=s.getProgramInfoLog(v).trim(),k=s.getShaderInfoLog(P).trim(),X=s.getShaderInfoLog(C).trim(),j=!0,W=!0;if(s.getProgramParameter(v,s.LINK_STATUS)===!1)if(j=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,v,P,C);else{let it=Xl(s,P,"vertex"),H=Xl(s,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(v,s.VALIDATE_STATUS)+`
...
`,document.head.appendChild(s)}let i=window.lenis||null;function t(e){e>100?gsap.to(document.documentElement,{duration:0,"--gap-size":1,ease:"power2.out"}):gsap.to(document.documentElement,{duration:0,"--gap-size":0,ease:"power2.out"})}i?i.on("scroll",({scroll:e})=>{t(e)}):$(window).scroll(function(){t($(this).scrollTop())})}var ac=0;function $e(i){window.lenisInstance&&(i===!0?t():e());function t(){ac=window.scrollY,$("body").css({overflow:"hidden",position:"fixed",top:"0",width:"100%"}),window.lenisInstance.scrollTo(0,{immediate:!0,onComplete:()=>{window.lenisInstance.stop()}})}function e(){$("body").css({overflow:"",position:"",top:"",width:""}),window.lenisInstance.start(),window.lenisInstance.scrollTo(ac,{})}}function Ap(){$("[data-scroll-top]").on("click",function(){window.lenisInstance?window.lenisInstance.scrollTo(0):window.scrollTo(0,0)})}function Cp(){function i(){let t=new Date,e={timeZone:"Europe/Paris",hour:"2-digit",minute:"2-digit",hour12:!0},n=t.toLocaleTimeString("en-GB",e);$("[data-time-cet]").text(`CET ${n}`)}i(),setInterval(i,1e3)}function Rp(){let t=document.querySelectorAll("[data-css-marquee]"),e=[],n;function s(h){if(h.getAttribute("data-initialized")==="true")return;h.querySelectorAll("[data-css-marquee-list]").forEach(d=>{let p=d.cloneNode(!0);h.appendChild(p)}),h.querySelectorAll("[data-css-marquee-list]").forEach(d=>{d.style.animationDuration=d.offsetWidth/60+"s",d.style.animationPlayState="paused"}),h.setAttribute("data-initialized","true"),e.push(h)}function r(h){let u=h.querySelectorAll("[data-css-marquee-list]");for(let p=u.length-1;p>=u.length/2;p--)u[p].remove();h.querySelectorAll("[data-css-marquee-list]").forEach(p=>{p.style.animationDuration="",p.style.animationPlayState=""}),h.setAttribute("data-initialized","false");let d=e.indexOf(h);d>-1&&e.splice(d,1)}function a(h){let u=parseInt(h.getAttribute("data-breakpoint")||"0");window.innerWidth<=u?s(h):h.getAttribute("data-initialized")==="true"&&r(h)}let o=new IntersectionObserver(h=>{h.forEach(u=>{u.target.getAttribute("data-initialized")==="true"&&u.target.querySelectorAll("[data-css-marquee-list]").forEach(d=>d.style.animationPlayState=u.isIntersecting?"running":"paused")})},{threshold:0});function l(){t.forEach(h=>{a(h),o.observe(h)})}function c(){clearTimeout(n),n=setTimeout(()=>{t.forEach(h=>{a(h)})},250)}window.addEventListener("resize",c),l()}function lc(){function i(n,s=!1){let r=document.getElementById(n);if(r&&window.lenisInstance){let a=()=>{window.lenisInstance.scrollTo(r,{duration:1,easing:o=>Math.min(1,1.001-Math.pow(2,-10*o))})};s?a():setTimeout(a,100),s&&window.history.pushState({},"",window.location.pathname+"?anchor="+n)}}let e=new URLSearchParams(window.location.search).get("anchor");e&&i(e),$('a[href^="?anchor="], a[href^="#"], a[href*="'+window.location.pathname+'?anchor="]').on("click",function(n){let s=$(this).attr("href"),r;if(s.startsWith("#"))r=s.substring(1);else if(s.includes("?anchor=")){let a=s.split("?"),o=window.location.pathname,l=a[0]||o;(l===o||l==="")&&(n.preventDefault(),r=new URLSearchParams(a[1]).get("anchor"))}r&&($(".nav_menu").is(":visible")?($e(!1),$('[data-nav-toggle="close"]').trigger("click"),setTimeout(()=>{i(r,!0)},500)):i(r,!0))})}function Ip(){$("[data-copy-clipboard]").on("click",function(){let i=$(this).attr("data-copy-clipboard"),t=$(`[data-copy-clipboard="${i}"]`).find(".line");if(t.length){let e=t.text(),n=()=>{let s=$('<div class="copy-tooltip">Copied</div>');s.css({position:"absolute",background:"var(--body-2)",color:"var(--text-2)",padding:".5em 1em",borderRadius:".25em",fontSize:"1.5rem",whiteSpace:"nowrap",zIndex:9999,pointerEvents:"none"});let r=t.offset();s.css({top:r.top-40,left:r.left+t.outerWidth()/2-s.outerWidth()/2}),$("body").append(s),setTimeout(()=>{s.remove()},1500)};navigator.clipboard.writeText(e).then(()=>{n()}).catch(()=>{let s=document.createElement("textarea");s.value=e,document.body.appendChild(s),s.select(),document.execCommand("copy"),document.body.removeChild(s),n()})}})}function oc(i){let t=new DOMParser().parseFromString(i.next.html,"text/html").querySelector("html").getAttribute("data-wf-page");document.documentElement.setAttribute("data-wf-page",t),window.Webflow&&window.Webflow.destroy(),window.Webflow&&window.Webflow.ready(),window.Webflow&&window.Webflow.require&&window.Webflow.require("ix2")&&window.Webflow.require("ix2").init(),$(".w--current").removeClass("w--current"),$("a").each(function(){$(this).attr("href")===window.location.pathname&&$(this).addClass("w--current")})}var Pp={isOpen:!1,$overlay:null,$container:null,$videoWrapper:null,$originalElement:null,originalMaxWidth:null,originalPlayers:[],modalPlayer:null,init(){this.initOriginalPlyrs(),this.bindEvents(),this.addStyles()},initOriginalPlyrs(){let i=$(".plyr_video");i.length&&(this.originalPlayers=[],i.each((t,e)=>{let n=new Plyr(e,{controls:["play","progress","mute","fullscreen"],muted:!0,autoplay:!0,loop:{active:!0}});$(e).closest("[data-video-player]").find(".plyr__controls").hide(),n.on("ready",()=>{setTimeout(()=>{n.play(),n.muted=!0},100)}),n.on("loadeddata",()=>{n.play()}),this.originalPlayers.push(n)}))},bindEvents(){$("[data-video-player]").each((i,t)=>{$(t).click(e=>{e.preventDefault(),this.open($(e.currentTarget))})})},open(i){if(this.isOpen)return;if(window.innerWidth<768||/Mobi|Android/i.test(navigator.userAgent)){let e=i.find("video")[0];if(e){e.removeAttribute("playsinline"),e.removeAttribute("webkit-playsinline"),e.controls=!1,e.currentTime=0,e.muted=!1;let n=()=>{e.removeEventListener("webkitendfullscreen",n),e.removeEventListener("fullscreenchange",n),e.pause(),e.setAttribute("playsinline",""),e.setAttribute("webkit-playsinline",""),e.controls=!1;let s=i.closest("[data-video-player]"),r=$(e).clone(!0)[0];e.replaceWith(r);let a=new Plyr(r,{controls:["play","progress","mute","fullscreen"],muted:!0,autoplay:!0,loop:{active:!0}});$(s).find(".plyr__controls").hide(),a.on("ready",()=>{a.play().catch(()=>{})})};e.addEventListener("webkitendfullscreen",n),e.addEventListener("fullscreenchange",()=>{document.fullscreenElement||n()}),e.play().then(()=>{let s=e.requestFullscreen||e.webkitEnterFullscreen||e.webkitRequestFullscreen||e.msRequestFullscreen;s&&s.call(e)}).catch(s=>{console.warn("Autoplay or fullscreen failed:",s)})}return}this.$originalElement=i,this.originalMaxWidth=i.css("max-width"),$e(!0),i.css("max-width","none"),this.createElement(),this.setupModal(i),this.animateIn(),this.isOpen=!0},close(){this.isOpen&&(this.pauseVideo(),this.animateOut())},createElement(){this.$overlay=$('<div class="video-modal-overlay"></div>'),this.$container=$('<div class="video-modal-container"></div>'),this.$videoWrapper=$('<div class="video-modal-wrapper"></div>');let i=$('<div class="video-modal-close">\xD7</div>');this.$videoWrapper.append(i),this.$container.append(this.$videoWrapper),this.$overlay.append(this.$container),$("body").append(this.$overlay),this.bindCloseEvents(i)},setupModal(i){let t=i[0].getBoundingClientRect(),e=i.attr("data-video-player")||"16/9";this.$container.css({position:"fixed",left:t.left+"px",top:t.top+"px",width:t.width+"px",height:t.height+"px",zIndex:9999}),this.$videoWrapper.css("aspect-ratio",e);let n=i.clone(!0);n.find(".plyr").replaceWith(n.find("video")),this.$videoWrapper.append(n),i.css("visibility","hidden")},animateIn(){gsap.set(this.$overlay,{opacity:0}),gsap.to(this.$overlay,{opacity:1,duration:.3}),gsap.to(this.$container,{left:"5vw",top:"5vh",width:"90vw",height:"90vh",duration:.6,ease:"power2.out",onComplete:()=>this.activateModalVideo()})},activateModalVideo(){let t=this.$videoWrapper.find("[data-video-player]").find(".plyr_video");t.length&&(this.modalPlayer=new Plyr(t[0],{controls:["play","progress","mute","fullscreen"],muted:!1,autoplay:!1,loop:{active:!0}}),this.modalPlayer.on("ready",()=>{setTimeout(()=>{this.modalPlayer.restart(),this.modalPlayer.muted=!1,this.modalPlayer.play().catch(()=>{})},100)}))},animateOut(){let i=this.$originalElement[0].getBoundingClientRect();gsap.to(this.$container,{left:i.left+"px",top:i.top+"px",width:i.width+"px",height:i.height+"px",duration:.4,ease:"power2.in"}),gsap.to(this.$overlay,{opacity:0,duration:.3,delay:.2,onComplete:()=>this.cleanup()})},cleanup(){this.$overlay.remove(),this.$originalElement.css({visibility:"visible","max-width":this.originalMaxWidth}),this.modalPlayer&&(this.modalPlayer.destroy(),this.modalPlayer=null),$e(!1),$(document).off("keydown.videoModal"),this.resetProperties()},resetProperties(){this.isOpen=!1,this.$overlay=null,this.$container=null,this.$videoWrapper=null,this.$originalElement=null,this.originalMaxWidth=null},bindCloseEvents(i){i.click(()=>this.close()),this.$overlay.click(t=>{t.target===this.$overlay[0]&&this.close()}),$(document).on("keydown.videoModal",t=>{t.key==="Escape"&&this.close()})},playVideo(){this.modalPlayer&&this.modalPlayer.play()},pauseVideo(){this.modalPlayer&&this.modalPlayer.pause()},addStyles(){$("<style>").text(`
        .video-modal-overlay {
            position: fixed;
            top: 0;
            left: 0;
